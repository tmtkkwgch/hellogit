...
function initChgArea() {
    ...
    if (kbnRadio == 1) {
        ...
        if (layoutRadio == 0) {
            ...
            areaShowOrHide('Left', document.forms[0].man350area1.value);
            areaShowOrHide('Right', document.forms[0].man350area2.value);
            areaShowOrHide('Top', document.forms[0].man350area3.value);
            areaShowOrHide('Bottom', document.forms[0].man350area4.value);
            areaShowOrHide('Center', document.forms[0].man350area5.value);
