...
function getNowSelUsr() {
    ...
    $('input:hidden[name=sml390banAccount]').each(function(){
        ...
        $('#cmn120SelectRightUser option').each(function(){
            ...
            if ($(this).val() != null && $(this).val() != 0 && $(this).val() != -1 && $(this).val() != "") {
                $('#atesaki_to_area').append("<div class=\"atesaki_to_user\" id=\"0\">" + htmlEscape($(this).text())
                                                     + "<input type=\"hidden\" name=\"sml390banAccount\" value=\""
                                                     + $(this).val()
...
$(function() {
    ...
    //宛先選択ボタン
    $(".sml_send_sel_btn").live("click", function(){
    	console.log("click sml_send_sel_btn!");
