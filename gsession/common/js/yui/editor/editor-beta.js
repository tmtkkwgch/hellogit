    ...
    YAHOO.extend(YAHOO.widget.SimpleEditor, YAHOO.util.Element, {
        ...
        */
        _getRange: function() {
            ...
            if ((this.browser.ie && isNotIE11()) || this.browser.opera) {
                try {
...
function getCntWndDoc(cntElm) {
    setTimeout("timeoutDc()",1000);
    return cntElm.get('iframe').get('element').contentWindow.document;
}
