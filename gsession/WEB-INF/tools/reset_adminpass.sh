...
then
    ...
    echo "Please change directory with the reset_adminpass.sh"
    exit 0
fi
...
$JAVA_HOME/bin/java -Xmx256M -classpath $CLASSPATH jp.groupsession.v3.tools.ResetAdminPassword $GSROOT
exit 0
