...
LOGDIR=../log
GSROOT=./../../../
POSTGRES_TABLE_SPACE="gsession_index"
...
$JAVA_HOME/bin/java -Xmx256M -classpath $CLASSPATH jp.groupsession.v3.tools.CreateIndexSqlFile $GSROOT $POSTGRES_TABLE_SPACE
exit 0
