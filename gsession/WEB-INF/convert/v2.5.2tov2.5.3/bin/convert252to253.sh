...
#dirCheck
if [ -f "convert252to253.sh" ]
then
    echo "Directory OK"
else
    echo "Please change directory with the convert252to253.sh"
    exit 0
fi
...
$JAVA_HOME/bin/java -Xmx256M -classpath $CLASSPATH jp.groupsession.v2.convert.Convert252To253 $GSROOT
