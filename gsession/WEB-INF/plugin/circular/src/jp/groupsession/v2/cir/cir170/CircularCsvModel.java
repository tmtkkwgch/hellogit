...
/**
 * <br>[機  能] 回覧板 アカウントインポート 取込みファイル(CSV)の情報を格納するクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 *
 */
public class CircularCsvModel extends AbstractModel
implements Comparator<CircularCsvModel> {
     ...
     */
    public int compare(CircularCsvModel obj1, CircularCsvModel obj2) {
