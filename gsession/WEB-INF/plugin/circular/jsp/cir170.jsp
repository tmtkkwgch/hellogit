...
<td width="100%" align="center">
  ...
  <td>
    ...
    <td class="td_type1">
      <input type="button" class="btn_attach" value="<gsmsg:write key="cmn.attached" />" name="attacheBtn" onClick="opnTemp('cir170selectFiles', '<bean:write name="cir170Form" property="cir170pluginId" />', '1', '0');">
      &nbsp;<input type="button" class="btn_delete" value="<gsmsg:write key="cmn.delete" />" name="dellBtn" onClick="buttonPush('deleteFile');"><br>
      <html:select property="cir170selectFiles" styleClass="select01" multiple="false" size="1">
        <html:optionsCollection name="cir170Form" property="cir170FileLabelList" value="value" label="label" />
      </html:select><br>
