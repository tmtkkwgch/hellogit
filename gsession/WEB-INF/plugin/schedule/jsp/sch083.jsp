...
<td width="100%" align="center">
  ...
  <td align="left">
    ...
    <td width="100%" class="header_ktool_bg_text2">[ <gsmsg:write key="schedule.sch083.1" /> ]</td>
    ...
    <td class="header_glay_bg" width="50%">
      <input type="button" value="<gsmsg:write key="cmn.delete" />" class="btn_dell_n1" onClick="buttonPush('sch083kakunin');">
      <input type="button" class="btn_back_n3" value="<gsmsg:write key="cmn.back.admin.setting" />" onClick="buttonPush('sch083back');"></td>
    ...
    <tr>
    <td class="table_bg_A5B4E1" width="15%"><span class="text_bb1"><gsmsg:write key="cmn.manual.delete2" /></span><span class="text_r2">※</span></td>
    <td class="td_type1">
      <span class="text_base"><gsmsg:write key="schedule.sch083.2" /></span><br><br>

      <gsmsg:write key="cmn.after.data.head" />
      <!-- 年 -->
      <html:select property="sch083DelYear">
        <html:optionsCollection name="sch083Form" property="sch083DelYearLabel" value="value" label="label" />
      </html:select>

      <!-- 月 -->
      <html:select property="sch083DelMonth">
