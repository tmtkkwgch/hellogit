...
<body class="body_03">
<html:form action="/schedule/sch095">
...
<logic:notEmpty name="sch095Form" property="sch100SvSearchTarget" scope="request">
  <logic:iterate id="svTarget" name="sch095Form" property="sch100SvSearchTarget" scope="request">
    <input type="hidden" name="sch100SvSearchTarget" value="<bean:write name="svTarget"/>">
  </logic:iterate>
</logic:notEmpty>
<logic:notEmpty name="sch095Form" property="sch100SearchTarget" scope="request">
  <logic:iterate id="target" name="sch095Form" property="sch100SearchTarget" scope="request">
    <input type="hidden" name="sch100SearchTarget" value="<bean:write name="target"/>">
  </logic:iterate>
</logic:notEmpty>
<logic:notEmpty name="sch095Form" property="sch100SvBgcolor" scope="request">
  <logic:iterate id="svBgcolor" name="sch095Form" property="sch100SvBgcolor" scope="request">
    <input type="hidden" name="sch100SvBgcolor" value="<bean:write name="svBgcolor"/>">
  </logic:iterate>
</logic:notEmpty>
<logic:notEmpty name="sch095Form" property="sch100Bgcolor" scope="request">
  <logic:iterate id="bgcolor" name="sch095Form" property="sch100Bgcolor" scope="request">
    <input type="hidden" name="sch100Bgcolor" value="<bean:write name="bgcolor"/>">
  </logic:iterate>
</logic:notEmpty>

<logic:notEmpty name="sch095Form" property="sch100CsvOutField" scope="request">
  <logic:iterate id="csvOutField" name="sch095Form" property="sch100CsvOutField" scope="request">
...
<td width="100%" align="center">
  ...
  <td align="left">
    ...
    <td class="header_glay_bg" width="50%">
      <input type="button" value="OK" class="btn_ok1" onClick="buttonPush('sch095kakunin');">
      <input type="button" class="btn_back_n1" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('sch095back');"></td>
    ...
    <td align="left" class="td_type20" width="100%">
      ...
      <html:radio name="sch095Form" styleId="sch095Smail_02" property="sch095Smail" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConstSchedule.SMAIL_NOT_USE) %>" /><label for="sch095Smail_02"><span class="text_base"><gsmsg:write key="cmn.dont.notify" /></span></label>&nbsp;
      <html:radio name="sch095Form" styleId="sch095Smail_01" property="sch095Smail" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConstSchedule.SMAIL_USE) %>" /><label for="sch095Smail_01"><span class="text_base"><gsmsg:write key="cmn.notify" /></span></label>
      ...
      <html:radio name="sch095Form" styleId="sch095SmailGroup_02" property="sch095SmailGroup" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConstSchedule.SMAIL_NOT_USE) %>" /><label for="sch095SmailGroup_02"><span class="text_base"><gsmsg:write key="cmn.dont.notify" /></span></label>&nbsp;
      <html:radio name="sch095Form" styleId="sch095SmailGroup_01" property="sch095SmailGroup" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConstSchedule.SMAIL_USE) %>" /><label for="sch095SmailGroup_01"><span class="text_base"><gsmsg:write key="cmn.notify" /></span></label>
      <hr style="border-color:#cccccc;">
      </td>
      </tr>
      <tr>
      ...
      <html:radio name="sch095Form" styleId="sch095SmailAttend_02" property="sch095SmailAttend" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConstSchedule.SMAIL_NOT_USE) %>" /><label for="sch095SmailAttend_02"><span class="text_base"><gsmsg:write key="cmn.dont.notify" /></span></label>&nbsp;
      <html:radio name="sch095Form" styleId="sch095SmailAttend_01" property="sch095SmailAttend" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConstSchedule.SMAIL_USE) %>" /><label for="sch095SmailAttend_01"><span class="text_base"><gsmsg:write key="cmn.notify" /></span></label>
      </td>
      </tr>
      </table>
    </td>
    ...
    <td width="100%" align="right" cellpadding="5" cellspacing="0">
      <input type="button" value="OK" class="btn_ok1" onClick="buttonPush('sch095kakunin');">
      <input type="button" class="btn_back_n1" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('sch095back');">
    </td>
    </tr>
    </table>
