...
<body class="body_03">
<html:form action="/schedule/sch094">
...
<logic:notEmpty name="sch094Form" property="sch100SvSearchTarget" scope="request">
  <logic:iterate id="svTarget" name="sch094Form" property="sch100SvSearchTarget" scope="request">
    <input type="hidden" name="sch100SvSearchTarget" value="<bean:write name="svTarget"/>">
  </logic:iterate>
</logic:notEmpty>
<logic:notEmpty name="sch094Form" property="sch100SearchTarget" scope="request">
  <logic:iterate id="target" name="sch094Form" property="sch100SearchTarget" scope="request">
    <input type="hidden" name="sch100SearchTarget" value="<bean:write name="target"/>">
  </logic:iterate>
</logic:notEmpty>
<logic:notEmpty name="sch094Form" property="sch100SvBgcolor" scope="request">
  <logic:iterate id="svBgcolor" name="sch094Form" property="sch100SvBgcolor" scope="request">
    <input type="hidden" name="sch100SvBgcolor" value="<bean:write name="svBgcolor"/>">
  </logic:iterate>
</logic:notEmpty>
<logic:notEmpty name="sch094Form" property="sch100Bgcolor" scope="request">
  <logic:iterate id="bgcolor" name="sch094Form" property="sch100Bgcolor" scope="request">
    <input type="hidden" name="sch100Bgcolor" value="<bean:write name="bgcolor"/>">
  </logic:iterate>
</logic:notEmpty>

<logic:notEmpty name="sch094Form" property="sch100CsvOutField" scope="request">
  <logic:iterate id="csvOutField" name="sch094Form" property="sch100CsvOutField" scope="request">
...
<td width="100%" align="center">
  ...
  <td align="left">
    ...
    <td width="100%" class="header_ktool_bg_text2">[ <gsmsg:write key="schedule.sch100.5" />　<gsmsg:write key="cmn.display.settings" /> ]</td>
    ...
    <td class="header_glay_bg" width="50%">
      <input type="button" value="OK" class="btn_ok1" onClick="buttonPush('sch094kakunin');">
      <input type="button" class="btn_back_n1" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('sch094back');"></td>
    ...
    <td width="100%" valign="middle" align="left" class="td_wt" >
      <!-- 件数 -->
      <html:select property="sch094DefLine">
        <html:optionsCollection name="sch094Form" property="sch094LineLabel" value="value" label="label" />
      </html:select>
    </td>
    </tr>
    ...
    <tr>
    <td width="0%" valign="middle" align="left" class="table_bg_A5B4E1" nowrap>
      <span class="text_bb1"><gsmsg:write key="cmn.set.auto.reflesh" /></span><span class="text_r2">※</span>
    </td>
    <td width="100%" valign="middle" align="left" class="td_wt" >
      <html:select name="sch094Form" property="sch094ReloadTime">
      <html:optionsCollection name="sch094Form" property="sch094TimeLabelList" value="value" label="label" />
      </html:select>
    </td>
    </tr>
    ...
    <tr>
    <td width="0%" valign="middle" align="left" class="table_bg_A5B4E1" nowrap>
      <span class="text_bb1"><gsmsg:write key="schedule.sch094.2" /></span><span class="text_r2">※</span>
    </td>
    <td width="100%" valign="middle" align="left" class="td_wt" >
      <html:select name="sch094Form" property="sch094SelWeek">
      <html:optionsCollection name="sch094Form" property="sch094WeekList" value="value" label="label" />
      </html:select>
    </td>
    </tr>
    ...
    <td width="100%" align="right" cellpadding="5" cellspacing="0">
      <input type="button" value="OK" class="btn_ok1" onClick="buttonPush('sch094kakunin');">
      <input type="button" class="btn_back_n1" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('sch094back');">
    </td>
    </tr>
    </table>
