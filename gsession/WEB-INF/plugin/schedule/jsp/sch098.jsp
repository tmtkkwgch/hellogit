...
<body class="body_03">
<html:form action="/schedule/sch098">
...
<logic:notEmpty name="sch098Form" property="sch100SvSearchTarget" scope="request">
  <logic:iterate id="svTarget" name="sch098Form" property="sch100SvSearchTarget" scope="request">
    <input type="hidden" name="sch100SvSearchTarget" value="<bean:write name="svTarget"/>">
  </logic:iterate>
</logic:notEmpty>
<logic:notEmpty name="sch098Form" property="sch100SearchTarget" scope="request">
  <logic:iterate id="target" name="sch098Form" property="sch100SearchTarget" scope="request">
    <input type="hidden" name="sch100SearchTarget" value="<bean:write name="target"/>">
  </logic:iterate>
</logic:notEmpty>
<logic:notEmpty name="sch098Form" property="sch100SvBgcolor" scope="request">
  <logic:iterate id="svBgcolor" name="sch098Form" property="sch100SvBgcolor" scope="request">
    <input type="hidden" name="sch100SvBgcolor" value="<bean:write name="svBgcolor"/>">
  </logic:iterate>
</logic:notEmpty>
<logic:notEmpty name="sch098Form" property="sch100Bgcolor" scope="request">
  <logic:iterate id="bgcolor" name="sch098Form" property="sch100Bgcolor" scope="request">
    <input type="hidden" name="sch100Bgcolor" value="<bean:write name="bgcolor"/>">
  </logic:iterate>
</logic:notEmpty>

<logic:notEmpty name="sch098Form" property="sch100CsvOutField" scope="request">
  <logic:iterate id="csvOutField" name="sch098Form" property="sch100CsvOutField" scope="request">
...
<td width="100%" align="center">
  ...
  <td align="left">
    ...
    <td width="100%" class="header_ktool_bg_text2">[ <gsmsg:write key="schedule.108" />　<gsmsg:write key="schedule.src.83" /><gsmsg:write key="cmn.display.settings" /> ]</td>
    ...
    <td class="header_glay_bg" width="50%">
      <input type="button" value="OK" class="btn_ok1" onClick="buttonPush('sch098kakunin');">
      <input type="button" class="btn_back_n1" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('sch098back');"></td>
    ...
    <td width="0%" valign="middle" align="left" class="table_bg_A5B4E1" nowrap>
      <span class="text_bb1"><gsmsg:write key="schedule.src.83" /></span><span class="text_r2">※</span>
    </td>
    <td width="100%" valign="middle" align="left" class="td_wt" >
    <html:radio name="sch098Form" styleId="sch098Dsp_02" property="sch098DefDsp" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConstSchedule.GROUP_SCH_SHOW) %>" /><label for="sch098Dsp_02"><span class="text_base"><gsmsg:write key="cmn.display.ok" /></span></label>&nbsp;
    <html:radio name="sch098Form" styleId="sch098Dsp_01" property="sch098DefDsp" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConstSchedule.GROUP_SCH_NOT_SHOW) %>" /><label for="sch098Dsp_01"><span class="text_base"><gsmsg:write key="cmn.dont.show" /></span></label>
    </td>
    </tr>
    ...
    <td width="100%" align="right" cellpadding="5" cellspacing="0">
      <input type="button" value="OK" class="btn_ok1" onClick="buttonPush('sch098kakunin');">
      <input type="button" class="btn_back_n1" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('sch098back');">
    </td>
    </tr>
    </table>
