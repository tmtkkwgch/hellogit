...
<script language="JavaScript" src="../schedule/js/sch084.js?<%= GSConst.VERSION_PARAM %>"></script>
...
<body class="body_03">
<html:form action="/schedule/sch084kn">
...
<html:hidden property="sch084repeatCheckFlg" />



<logic:notEmpty name="sch084knForm" property="sch100SvSearchTarget" scope="request">
  <logic:iterate id="svTarget" name="sch084knForm" property="sch100SvSearchTarget" scope="request">
    <input type="hidden" name="sch100SvSearchTarget" value="<bean:write name="svTarget"/>">
  </logic:iterate>
</logic:notEmpty>
<logic:notEmpty name="sch084knForm" property="sch100SearchTarget" scope="request">
  <logic:iterate id="target" name="sch084knForm" property="sch100SearchTarget" scope="request">
    <input type="hidden" name="sch100SearchTarget" value="<bean:write name="target"/>">
  </logic:iterate>
</logic:notEmpty>
<logic:notEmpty name="sch084knForm" property="sch100SvBgcolor" scope="request">
  <logic:iterate id="svBgcolor" name="sch084knForm" property="sch100SvBgcolor" scope="request">
    <input type="hidden" name="sch100SvBgcolor" value="<bean:write name="svBgcolor"/>">
  </logic:iterate>
</logic:notEmpty>
<logic:notEmpty name="sch084knForm" property="sch100Bgcolor" scope="request">
  <logic:iterate id="bgcolor" name="sch084knForm" property="sch100Bgcolor" scope="request">
    <input type="hidden" name="sch100Bgcolor" value="<bean:write name="bgcolor"/>">
  </logic:iterate>
</logic:notEmpty>

<logic:notEmpty name="sch084knForm" property="sch100CsvOutField" scope="request">
  <logic:iterate id="csvOutField" name="sch084knForm" property="sch100CsvOutField" scope="request">
...
<!-- タイトル -->
    ...
    <td width="100%" class="header_ktool_bg_text2">[ <gsmsg:write key="schedule.108" /> <gsmsg:write key="main.man029kn.2" /> ]</td>
  ...
  <td>
    ...
    <td class="td_type1">
    <a href="../schedule/sch084kn.do?CMD=downLoad">
    <span class="text_link_min"><bean:write name="sch084knForm" property="sch084knFileName" /></span>
    </a>
    </td>
    </tr>
    <tr>
    <td class="table_bg_A5B4E1"><span class="text_bb1"><gsmsg:write key="cmn.capture.item.count" /></span></td>
    <td class="td_type1"><bean:write name="sch084knForm" property="impDataCnt" /><gsmsg:write key="cmn.number" /></td>
    </tr>


    <tr>
    <td class="table_bg_A5B4E1"><span class="text_bb1"><gsmsg:write key="schedule.sch084.2" /></span></td>
    <td class="td_type1">
      <logic:equal name="sch084Form" property="sch084repeatCheckFlg" value="1">
      <gsmsg:write key="schedule.sch084.1" /></label>
      </logic:equal>
    </td>
    </tr>
