...
/**
 * <br>[機  能] スケジュール 管理者設定 スケジュールインポート画面のビジネスロジッククラス
 * <br>[解  説]
 * <br>[備  考]
 */
public class Sch084Biz {
     ...
     */
    public Sch084Biz(Connection con, RequestModel reqMdl) {
        reqMdl__ = reqMdl;
        con_ = con;
    }
     ...
     * <br>[備  考]
     *
     * @param paramMdl Sch084ParamModel
     * @param tempDir テンポラリディレクトリパス
     * @throws SQLException SQL実行例外
     * @throws IOToolsException ファイルアクセス時例外
     */
    public void setInitData(Sch084ParamModel paramMdl, String tempDir)
        ...
        paramMdl.setSch084FileLabelList(fileLblList);
    }
}