...
public class Sch088Action extends AbstractScheduleAdminAction {
    ...
    public ActionForward executeAction(ActionMapping map, ActionForm form,
        ...
        if (cmd.equals("sch088kakunin")) {
            //確認
            forward = __doKakunin(map, schForm, req, res, con);
        } else if (cmd.equals("sch088commit")) {
            //登録
            forward = __doCommit(map, schForm, req, res, con);
        } else if (cmd.equals("sch088back")) {
            //戻る
...
//        ActionForward urlForward = null;
        ...
        cmn999Form.addHiddenParam("sch088smlSendKbn", form.getSch088smlSendKbn());
        cmn999Form.addHiddenParam("sch088Smail", form.getSch088Smail());
        cmn999Form.addHiddenParam("sch088SmailGroup", form.getSch088SmailGroup());
        cmn999Form.addHiddenParam("sch088SmailAttend", form.getSch088SmailAttend());
    ...
    private void __setCompPageParam(
        ...
        cmn999Form.setIcon(Cmn999Form.ICON_INFO);
        cmn999Form.setWtarget(Cmn999Form.WTARGET_BODY);
        urlForward = map.findForward("sch088back");
     ...
     * @throws SQLException SQL実行時例外
     */
    private ActionForward __doBack(ActionMapping map, Sch088Form form,
            HttpServletRequest req, HttpServletResponse res, Connection con)
            throws SQLException {

        log__.debug("戻る");
        ActionForward forward = null;
        forward = map.findForward("sch088back");
        return forward;
    }
