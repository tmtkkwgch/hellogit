...
/**
 * <br>[機  能] 1日毎のスケジュール情報を格納するModelクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class SimpleScheduleModel extends AbstractModel {
    ...
    /** 期間情報 */
    private Sch010PeriodModel periodMdl__;


    /** 他プラグインス遷移先URL*/
    private String schAppendUrl__;

    /**
     * <p>periodMdl を取得します。
     * @return periodMdl
     */
    public Sch010PeriodModel getPeriodMdl() {
        return periodMdl__;
    }
    /**
     * <p>periodMdl をセットします。
     * @param periodMdl periodMdl
     */
    public void setPeriodMdl(Sch010PeriodModel periodMdl) {
        periodMdl__ = periodMdl;
    }
    /**
     * <p>userKbn を取得します。
     * @return userKbn
    ...
    /**
     * <p>schAppendUrl を取得します。
     * @return schAppendUrl
     */
    public String getSchAppendUrl() {
        return schAppendUrl__;
    }
    /**
     * <p>schAppendUrl をセットします。
     * @param schAppendUrl schAppendUrl
     */
    public void setSchAppendUrl(String schAppendUrl) {
        schAppendUrl__ = schAppendUrl;
    }
}
