...
/**
 * <br>[機  能] スケジュール 初期表示設定画面のアクションクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Sch096Action extends AbstractScheduleAction {

    /** Logging インスタンス */
    private static Log log__ = LogFactory.getLog(Sch096Action.class);
    ...
    public ActionForward executeAction(ActionMapping map, ActionForm form,
        ...
        Sch096Form schForm = (Sch096Form) form;
        if (form == null) {
        ...
        if (cmd.equals("sch096kakunin")) {
            //確認
            forward = __doKakunin(map, schForm, req, res, con);
        } else if (cmd.equals("sch096commit")) {
            //登録
            forward = __doCommit(map, schForm, req, res, con);
        } else if (cmd.equals("sch096back")) {
            //戻る
...
//        ActionForward urlForward = null;
        ...
        /** メッセージ スケジュール初期表示設定 **/
        String mkey1 = gsMsg.getMessage(req, "schedule.sch096.1");
        ...
        cmn999Form.addHiddenParam("sch096DefDsp", form.getSch096DefDsp());
     ...
     * @throws SQLException SQL実行時例外
     */
    private ActionForward __doCommit(ActionMapping map, Sch096Form form,
            HttpServletRequest req, HttpServletResponse res, Connection con)
            throws SQLException {
        log__.debug("登録");
        ActionForward forward = null;
        ...
        //DB更新
        Sch096Biz biz = new Sch096Biz(getRequestModel(req));
        RequestModel reqMdl = getRequestModel(req);
        BaseUserModel umodel = getSessionUserModel(req);

        Sch096ParamModel paramMdl = new Sch096ParamModel();
    ...
    private void __setCompPageParam(
        ...
        cmn999Form.setIcon(Cmn999Form.ICON_INFO);
        cmn999Form.setWtarget(Cmn999Form.WTARGET_BODY);
        urlForward = map.findForward("sch096back");
        cmn999Form.setUrlOK(urlForward.getPath());

        GsMessage gsMsg = new GsMessage();
        /** メッセージ スケジュール初期表示設定 **/
        String key1 = gsMsg.getMessage(req, "schedule.sch096.1");
     ...
     * @throws SQLException SQL実行時例外
     */
    private ActionForward __doBack(ActionMapping map, Sch096Form form,
            HttpServletRequest req, HttpServletResponse res, Connection con)
            throws SQLException {

        log__.debug("戻る");
        ActionForward forward = null;
        forward = map.findForward("sch096back");
        return forward;
    }
     ...
     * @throws SQLException SQL実行時例外
     */
    private ActionForward __doInit(ActionMapping map, Sch096Form form,
            HttpServletRequest req, HttpServletResponse res, Connection con)
            throws SQLException {
