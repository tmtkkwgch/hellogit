...
/**
 * <br>[機  能] スケジュール一覧表示設定画面のアクションクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Sch094Action extends AbstractScheduleAction {

    /** Logging インスタンス */
    private static Log log__ = LogFactory.getLog(Sch094Action.class);
    ...
    public ActionForward executeAction(ActionMapping map, ActionForm form,
        ...
        Sch094Form schForm = (Sch094Form) form;
        if (form == null) {
        ...
        if (cmd.equals("sch094kakunin")) {
            //確認
            forward = __doKakunin(map, schForm, req, res, con);
        } else if (cmd.equals("sch094commit")) {
            //登録
            forward = __doCommit(map, schForm, req, res, con);
        } else if (cmd.equals("sch094back")) {
            //戻る
...
//        ActionForward urlForward = null;
        ...
        /** メッセージ スケジュール一覧表示設定 **/
        String mkey1 = gsMsg.getMessage(req, "schedule.sch090.4");
        cmn999Form.setMessage(msgRes.getMessage(msgState, mkey1));

        cmn999Form.addHiddenParam("backScreen", form.getBackScreen());
        cmn999Form.addHiddenParam("sch094DefLine", form.getSch094DefLine());
        cmn999Form.addHiddenParam("sch094ReloadTime", form.getSch094ReloadTime());
        cmn999Form.addHiddenParam("sch094SelWeek", form.getSch094SelWeek());
     ...
     * @throws SQLException SQL実行時例外
     */
    private ActionForward __doCommit(ActionMapping map, Sch094Form form,
            HttpServletRequest req, HttpServletResponse res, Connection con)
            throws SQLException {
        log__.debug("登録");
        ActionForward forward = null;
        ...
        Sch094Biz biz = new Sch094Biz(reqMdl);

        Sch094ParamModel paramMdl = new Sch094ParamModel();
    ...
    private void __setCompPageParam(
        ...
        cmn999Form.setIcon(Cmn999Form.ICON_INFO);
        cmn999Form.setWtarget(Cmn999Form.WTARGET_BODY);
        urlForward = map.findForward("sch094back");
        ...
        /** メッセージ スケジュール一覧表示設定 **/
        String key1 = gsMsg.getMessage(req, "schedule.sch090.4");
     ...
     * @throws SQLException SQL実行時例外
     */
    private ActionForward __doBack(ActionMapping map, Sch094Form form,
            HttpServletRequest req, HttpServletResponse res, Connection con)
            throws SQLException {

        log__.debug("戻る");
        ActionForward forward = null;
        forward = map.findForward("sch094back");
        return forward;
    }
     ...
     * @throws SQLException SQL実行時例外
     */
    private ActionForward __doInit(ActionMapping map, Sch094Form form,
            HttpServletRequest req, HttpServletResponse res, Connection con)
            throws SQLException {
