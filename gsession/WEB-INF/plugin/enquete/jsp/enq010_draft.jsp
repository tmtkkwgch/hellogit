      ...
      <tbody>
        ...
        <% } %>
          ...
          <%
            ...
            String[] widthList = {"0", "13", "34", "13", "13", "17"};
        ...
        <% } %>
          <td class="td_type1" align="left" valign="middle" nowrap>
          ...
          <td class="td_type1" align="center" valign="top" >
            <span class="text_base2"><bean:write name="enqData" property="ansLimitDate" /></span>
          </td>
            <td class="td_type1" align="center" valign="top">
              <span class="text_base2">
              ...
              &nbsp;～
              <br><gsmsg:write key="main.man200.9" />
              </logic:empty>
              <logic:notEmpty name="enqData" property="pubEndDateStr">
              &nbsp;～
              <br><bean:write name="enqData" property="pubEndDateStr" />
              </logic:notEmpty>
              </logic:equal>
