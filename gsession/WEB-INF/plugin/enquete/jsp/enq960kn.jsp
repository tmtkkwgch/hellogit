  ...
  <td align="center">
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
      <tr>
        ...
        <td width="100%" class="header_ktool_bg_text2">[ <gsmsg:write key="enq.enq960kn.01"/> ]</td>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
      <tr>
        ...
        <td class="header_glay_bg" width="50%">
          <input type="button" value="<gsmsg:write key='cmn.final' />" class="btn_base1" onClick="buttonPush('enq960kncommit');">
          <input type="button" value="<gsmsg:write key='cmn.back' />" class="btn_back_n1" onClick="buttonPush('enq960knback');">
        </td>
