 ...
 * @author JTS
 */
public class Enq010SearchModel extends AbstractParamModel {
    /** セッションユーザSID */
    ...
    /** 結果公開期限 開始 */
    private UDate resPubLimitDateFrom__ = null;
    /** 結果公開期限 終了 */
    private UDate resPubLimitDateTo__ = null;
    /** 重要度 */
    ...
    /** 状態 期限切れ*/
    private int[] statusAnsOver__ = null;
    ...
    /**
     * <p>resPubLimitDateFrom を取得します。
     * @return resPubLimitDateFrom
     */
    public UDate getResPubLimitDateFrom() {
        return resPubLimitDateFrom__;
    }
    /**
     * <p>resPubLimitDateFrom をセットします。
     * @param resPubLimitDateFrom resPubLimitDateFrom
     */
    public void setResPubLimitDateFrom(UDate resPubLimitDateFrom) {
        resPubLimitDateFrom__ = resPubLimitDateFrom;
    }
    /**
     * <p>resPubLimitDateTo を取得します。
     * @return resPubLimitDateTo
     */
    public UDate getResPubLimitDateTo() {
        return resPubLimitDateTo__;
    }
    /**
     * <p>resPubLimitDateTo をセットします。
     * @param resPubLimitDateTo resPubLimitDateTo
     */
    public void setResPubLimitDateTo(UDate resPubLimitDateTo) {
        resPubLimitDateTo__ = resPubLimitDateTo;
    }
    /**
     * <p>statusAnsOver を取得します。
     * @return statusAnsOver
     */
    public int[] getStatusAnsOver() {
        return statusAnsOver__;
    }
    /**
     * <p>statusAnsOver をセットします。
     * @param statusAnsOver statusAnsOver
     */
    public void setStatusAnsOver(int[] statusAnsOver) {
        statusAnsOver__ = statusAnsOver;
    }
