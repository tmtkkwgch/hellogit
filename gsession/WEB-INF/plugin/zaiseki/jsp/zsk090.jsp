...
<td width="100%" align="center">
  ...
  <td align="left">
    ...
    <td class="header_glay_bg" width="50%">
      <input type="button" value="OK" class="btn_ok1" onClick="buttonPush('zsk090kakunin');">
      <input type="button" class="btn_back_n1" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('zsk090back');"></td>
    ...
    <tr>
    <td class="table_bg_A5B4E1" width="20%" nowrap><span class="text_bb1"><gsmsg:write key="cmn.auto.reload.time" /></span><span class="text_r2"><gsmsg:write key="cmn.comments" /></span></a></td>
    ...
    <td width="100%" align="right" cellpadding="5" cellspacing="0">
      <input type="button" value="OK" class="btn_ok1" onClick="buttonPush('zsk090kakunin');">
      <input type="button" class="btn_back_n1" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('zsk090back');">
    </td>
    </tr>
    </table>
