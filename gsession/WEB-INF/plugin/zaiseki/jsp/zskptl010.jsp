...
<logic:iterate id="userMdl" name="zskptl010Form" property="userList" scope="request" indexId="idx">
  <!-- 在席カラー設定 -->
  <!-- 在席 -->
...
<script type="text/javascript">
  $('#tooltips_zskptl010_<%= String.valueOf(zskGrpSid.intValue()) %> * a').tooltip();
</script>
