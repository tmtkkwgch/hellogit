...
<td width="100%" align="center" cellpadding="5" cellspacing="0">
  ...
  <td>
    ...
    <td width="50%" class="header_ktool_bg_text2">[ <gsmsg:write key="main.man140kn.1" /> ]</td>
    ...
    <tr>
    <td class="table_bg_A5B4E1" width="0%" nowrap><span class="text_bb1"><gsmsg:write key="main.man140.1" /></span></td>
