...
<!-- <gsmsg:write key="cmn.title" /> -->
    ...
    <td width="100%" class="header_ktool_bg_text2">[ <gsmsg:write key="main.holiday.template" /> <gsmsg:write key="main.man029kn.2" /> ]</td>
    ...
    <td class="header_glay_bg" width="50%">
      ...
      <input type="button" value="<gsmsg:write key="cmn.back" />" class="btn_back_n1" onclick="buttonPush('back_import');">
    </td>
  ...
  <td>
    ...
    <span class="text_link_min"><bean:write name="man029knForm" property="man029knFileName" /></span>
    </a>
    </td>
    </tr>
    <tr>
    <td class="table_bg_A5B4E1"><span class="text_bb1"><gsmsg:write key="cmn.capture.item.count" /></span></td>
    <td class="td_type1"><bean:write name="man029knForm" property="impDataCnt" /><gsmsg:write key="cmn.number" /></td>
    </tr>
    <tr>
