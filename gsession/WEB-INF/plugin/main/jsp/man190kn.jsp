...
<!--　BODY -->
<html:form action="/main/man190kn">
<input type="hidden" name="CMD" value="">
<html:hidden property="man190Year" />
<html:hidden property="man190Month" />
...
<td width="100%" align="center">
  ...
  <td>
    ...
    <td width="100%" class="header_ktool_bg_text2">[ <gsmsg:write key="main.man190kn.1" /> ]</td>
    ...
    <td class="td_type1">
      <bean:define id="yr" name="man190knForm" property="man190Year" type="java.lang.Integer" />
      <bean:define id="month" name="man190knForm" property="man190Month" type="java.lang.Integer" />
