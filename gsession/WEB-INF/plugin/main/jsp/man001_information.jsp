...
<%@ taglib uri="/WEB-INF/ctag-css.tld" prefix="theme" %>
    ...
    <td align="left" class="header_7D91BD_left" colspan="1">
      ...
      <tr>
      <td align="left">
        <img src="../main/images/menu_icon_single_info.gif" class="img_bottom img_border img_menu_icon_single" alt="<gsmsg:write key="cmn.information" />">
        <logic:equal name="man001Form" property="infoConf" value="true">
          <a href="javascript:void(0);" onClick="buttonPush2('infoSetting');"><gsmsg:write key="cmn.information" /></a>
        </logic:equal>
        <logic:notEqual name="man001Form" property="infoConf" value="true">
          <a><gsmsg:write key="cmn.information" /></a>
        </logic:notEqual>
      </td>
      <td align="right">
        <logic:equal name="man001Form" property="infoConf" value="true">
