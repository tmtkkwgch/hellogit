...
<script language="JavaScript" src="../main/js/man040.js?<%= GSConst.VERSION_PARAM %>"></script>
...
<td width="100%" align="center" cellpadding="5" cellspacing="0">
  ...
  <td>
    ...
    <td width="50%" class="header_ktool_bg_text2">[ <gsmsg:write key="main.man040.1" /> ]</td>
    ...
    <td class="header_glay_bg" width="50%">
      ...
      <input type="button" value="<gsmsg:write key="cmn.back2" />" class="btn_back_n1" onClick="buttonPush('040_back');">
    ...
    <td width="100%"></td>
    <td width="0%">
     <input type="button" value="<gsmsg:write key="main.man040.2" />" class="btn_base1" onClick="buttonPush('execution');">
    </td>
    </tr>
    </table>
