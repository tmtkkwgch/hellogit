...
<td width="100%" align="center">
  ...
  <td align="left">
    ...
    <td width="100%" class="header_ktool_bg_text2">[ <gsmsg:write key="main.memberships.conf.kn" /> ]</td>
    ...
    <td class="header_glay_bg" width="50%">
      <input type="button" name="btn_add" class="btn_base1" value="<gsmsg:write key="cmn.run" />" onClick="buttonPush('man330kn_commit');">
      <input type="button" name="btn_back" class="btn_back_n1" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('man330kn_back');">
    </td>
    ...
    <td valign="middle" align="left" class="td_nrlb" width="100%">
      <span class="text_base"><bean:write name="man330knForm" property="man330knFileName" /></span>
    </td>
    </tr>
    ...
    <td valign="middle" align="left" class="td_nrlb" width="100%">
      <logic:notEmpty name="man330knForm" property="man330knImpList" scope="request">
