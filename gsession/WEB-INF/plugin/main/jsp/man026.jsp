...
<td width="100%" align="center" cellpadding="5" cellspacing="0">
  ...
  <td align="left">
    ...
    <logic:equal name="man026Form" property="processMode" scope="request" value="addTemp">
    <td width="50%" class="header_ktool_bg_text2">[ <gsmsg:write key="main.man026.1" /> ]</td>
    </logic:equal>
    <logic:equal name="man026Form" property="processMode" scope="request" value="editTemp">
    <td width="50%" class="header_ktool_bg_text2">[ <gsmsg:write key="main.man026.2" /> ]</td>
    </logic:equal>
    ...
    <td>
      ...
      <logic:equal name="man026Form" property="processMode" scope="request" value="addTemp">
        <input type="button" value="<gsmsg:write key="main.man026.3" />" class="btn_base1w" onclick="buttonPush('normal')">
      </logic:equal>
    ...
    <th width="35%"><gsmsg:write key="cmn.date2" /></th>
    ...
    <td>
      <html:text property="man026HltName" size="60" maxlength="20" style="width:100%;" />
    </td>
    </tr>

    <tr>
    <td width="100%" colspan="2" class="td_type11" align="left">
      <html:multibox name="man026Form" property="man026FuriFlg" value="0" />
