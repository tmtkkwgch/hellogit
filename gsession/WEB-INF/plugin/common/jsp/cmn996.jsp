...
<!--
  ...
  function onForward(){
      ...
      var forwardUrl;
      forwardUrl = "<bean:write name="cmn996Form" property="urlOK" filter="false" />";
...
<html:form action="/common/cmn996" target="_self">
...
<div id="contair">
  ...
  <div id="information_body">
    ...
    <div class="information_middle_div">
      ...
      <span class="text_base_b"><bean:write name="cmn996Form" property="message" filter="false"/></span>
      </td>
      </tr>
      </table>
    </div>
    ...
    <div class="information_middle_button">
      <logic:notEqual name="cmn996Form" property="type_popup" value="1">
        <input type="button" value="<bean:write name="cmn996Form" property="okBtnValue"/>" class="btn_ok1" onClick="return onForward();">
      </logic:notEqual>
