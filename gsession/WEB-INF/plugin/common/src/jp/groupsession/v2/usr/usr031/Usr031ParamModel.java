 ...
 * @author JTS
 */
public class Usr031ParamModel extends Usr030ParamModel {
     ...
     */
    public ActionErrors validateAdd(ActionMapping map, RequestModel reqMdl,
            Connection con, boolean canChangePassword) throws Exception {
