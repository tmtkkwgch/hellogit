package jp.groupsession.v2.usr.usr021;
...
/**
 * <br>[機  能] グループ選択(チェックボックス選択方式)のアクションクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Usr021Action extends AdminAction {

    /** Logging インスタンス */
    private static Log log__ = LogFactory.getLog(Usr021Action.class);
