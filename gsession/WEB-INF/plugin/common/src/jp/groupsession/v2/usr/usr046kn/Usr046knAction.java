...
/**
 * <br>[機  能] ユーザ情報 ラベル登録確認画面のアクションクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Usr046knAction extends AbstractUsrAction {

    /** Logging インスタンス */
    private static Log log__ = LogFactory.getLog(Usr046knAction.class);
    ...
    public ActionForward executeAction(
        ...
        log__.debug("START_Usr046kn");
        ActionForward forward = null;

        Usr046knForm thisForm = (Usr046knForm) form;
    ...
    private ActionForward __doInit(
        ...
        Usr046knBiz biz = new Usr046knBiz();
        Usr046knParamModel paramMdl = new Usr046knParamModel();
    ...
    private ActionForward __doKakutei(
        ...
        cmnBiz.outPutCommonLog(map, getRequestModel(req), gsMsg, con,
                ...
                "[LabelName]" + form.getUsr046LabelName()
                + " [LabelBiko]" + NullDefault.getString(form.getUsr046bikou(), ""));
    ...
    private ActionForward __setKanryoDsp(
        ...
        //OKボタンクリック時遷移先
        ActionForward forwardOk = map.findForward("labListBack");
        cmn999Form.setUrlOK(forwardOk.getPath());

        MessageResources msgRes = getResources(req);

        int procMode = form.getUsr044ProcMode();
        ...
        if (procMode == GSConstUser.PROCMODE_ADD) {
            ...
            cmn999Form.setMessage(
                    msgRes.getMessage("touroku.kanryo.object", textLabel));
        } else if (procMode == GSConstUser.PROCMODE_EDIT) {
            //更新完了
            cmn999Form.setMessage(
                    msgRes.getMessage("hensyu.kanryo.object", textLabel));
        }
