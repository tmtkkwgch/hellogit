...
import jp.groupsession.v2.man.man060.Man060ParamModel;

/**
 * <br>[機  能] メイン 管理者設定 ディスク容量管理確認画面の情報を保持するModelクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Man060knParamModel extends Man060ParamModel {
    /** 画面表示用警告文字列 */
