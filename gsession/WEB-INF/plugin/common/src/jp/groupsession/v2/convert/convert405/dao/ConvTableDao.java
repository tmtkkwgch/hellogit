package jp.groupsession.v2.convert.convert405.dao;
...
public class ConvTableDao extends AbstractDao {
    ...
    private List<SqlBuffer> __createSQL() throws SQLException {
        ...
        //ポータルポートレットポートレットテーブル not null制約を削除
        sql = new SqlBuffer();
        sql.addSql("ALTER TABLE PTL_PORTLET ALTER COLUMN PLT_CONTENT_URL DROP NOT NULL;");
        sqlList.add(sql);
