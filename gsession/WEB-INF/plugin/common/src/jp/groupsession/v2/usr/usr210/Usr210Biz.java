...
public class Usr210Biz {
     ...
     */
    public Usr210Biz(RequestModel reqMdl) {
        reqMdl__ = reqMdl;
    }
    /**
     * <br>[機  能] 初期表示情報を設定する
     * <br>[解  説]
     * <br>[備  考]
     * @param paramMdl Usr210ParamModel
     * @param con コネクション
    ...
    public void setInitData(
            Usr210ParamModel paramMdl, Connection con, int sessionUserSid, int catSid)
    throws Exception {
