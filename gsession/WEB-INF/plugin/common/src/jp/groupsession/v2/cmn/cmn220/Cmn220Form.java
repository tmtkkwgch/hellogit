...
/**
 * <br>[機  能] グループ一覧ポップアップのフォーム
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Cmn220Form extends AbstractGsForm {
    ...
    /** 親画面のフォーム名 */
    String parentFormName__ = null;
    /** 親画面非submit時に実行するボタン */
    String paramBtn__ = null;
    /** グループタブ表示フラグ */
    int selGrpFlg__ = 0;
    /** システム管理グループ表示フラグ */
    int admGpFlg__ = 0;
     ...
     * @param cmn220banGroupSid cmn220banGroupSid
     */
    ...
    public void validatePrm(HttpServletRequest req) {
        ...
        if (req.getParameter("cmn220userSidTop") != null) {
            cmn220userSidTop__ = array;
        }
        if (req.getParameter("cmn220userSidBottom") != null) {
            cmn220userSidBottom__ = array;
        }
        if (req.getParameter("cmn220groupSidTop") != null) {
            cmn220userSidTop__ = array;
        }
        if (req.getParameter("cmn220groupSidBottom") != null) {
            cmn220userSidBottom__ = array;
        }
    }
    /**
     * <p>parentFormName を取得します。
     * @return parentFormName
     */
    public String getParentFormName() {
        return parentFormName__;
    }
    /**
     * <p>parentFormName をセットします。
     * @param parentFormName parentFormName
     */
    public void setParentFormName(String parentFormName) {
        parentFormName__ = parentFormName;
    }
    /**
     * <p>paramBtn を取得します。
     * @return paramBtn
     */
    public String getParamBtn() {
        return paramBtn__;
    }
    /**
     * <p>paramBtn をセットします。
     * @param paramBtn paramBtn
     */
    public void setParamBtn(String paramBtn) {
        paramBtn__ = paramBtn;
    }
    /**
