...
import jp.groupsession.v2.man.man340.Man340ParamModel;

/**
 * <br>[機  能] メイン 管理者設定 プラグイン追加確認画面の情報を保持するModelクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Man340knParamModel extends Man340ParamModel {
    /** バイナリSID */
