...
/**
 * <br>[機  能] メイン 管理者設定 グループインポート画面のビジネスロジッククラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Usr013Biz {

    /** Logging インスタンス */
    private static Log log__ = LogFactory.getLog(Usr013Biz.class);
     ...
     * <br>[解  説]
     * <br>[備  考]
     * @param paramMdl Usr013ParamModel
     * @param tempDir テンポラリディレクトリパス
     * @throws IOToolsException ファイルアクセス時例外
     */
    public void setInitData(
        Usr013ParamModel paramMdl,
        ...
        paramMdl.setUsr013FileLabelList(fileLblList);
    }
}