...
/**
 * <br>[機  能] メイン 管理者設定 オペレーションログ手動削除確認画面のアクションクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Man380knAction extends AdminAction {

    /** Logging インスタンス */
    private static Log log__ = LogFactory.getLog(Man380knAction.class);
     ...
     */
     public ActionForward executeAction(ActionMapping map,
         ...
         Man380knForm manform = (Man380knForm) form;
     ...
     * @throws Exception 実行時例外
     ...
     public ActionForward __doDelete(ActionMapping map,
         ...
         try {
             Man380knParamModel paramMdl = new Man380knParamModel();
             paramMdl.setParam(form);
             Man380knBiz biz = new Man380knBiz();
             biz.deleteOperationLogHistory(con, paramMdl);
             paramMdl.setFormData(form);

             commit = true;

         } catch (SQLException e) {
             log__.error("オペレーションログ手動削除失敗", e);
             throw e;
         } finally {
             if (commit) {
                 con.commit();
         ...
         cmnBiz.outPutCommonLog(map, reqMdl, gsMsg, con,
                 ...
                 "[year]" + form.getMan380Year() + " [month]" + form.getMan380Month());
     ...
     private ActionForward __setUpdateComp(ActionMapping map,
         ...
         cmn999Form.setMessage(
                 msgRes.getMessage(
                         ...
                         getInterMessage(req, GSConstMain.TEXT_OPLOG_SYUDODEL)));
