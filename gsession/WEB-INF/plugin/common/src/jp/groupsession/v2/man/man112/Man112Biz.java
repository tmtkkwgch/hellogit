...
/**
 * <br>[機  能] メイン 管理者設定 役職インポート画面のビジネスロジッククラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Man112Biz {

    /** Logging インスタンス */
    private static Log log__ = LogFactory.getLog(Man112Biz.class);
     ...
     * @throws IOToolsException ファイルアクセス時例外
     */
    public void setInitData(Man112ParamModel paramMdl, String tempDir)
    throws SQLException, IOToolsException {
        ...
        paramMdl.setMan112FileLabelList(fileLblList);
    }
}