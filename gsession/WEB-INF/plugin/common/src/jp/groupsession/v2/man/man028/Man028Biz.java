...
/**
 * <br>[機  能] メイン 管理者設定 休日設定インポート画面のビジネスロジッククラス
 * <br>[解  説]
 * <br>[備  考]
 * @author JTS
 */
public class Man028Biz {

    /** Logging インスタンス */
    private static Log log__ = LogFactory.getLog(Man028Biz.class);
     ...
     * @throws IOToolsException ファイルアクセス時例外
     */
    public void setInitData(Man028ParamModel paramMdl, String tempDir)
        ...
        paramMdl.setMan028FileLabelList(fileLblList);
    }
}