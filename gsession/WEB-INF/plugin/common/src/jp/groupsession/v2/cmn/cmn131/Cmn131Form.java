...
/**
 * <br>[機  能] メイン 個人設定 マイグループ登録画面のフォーム
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Cmn131Form extends AbstractGsForm {
    ...
    public ActionErrors validateCheck(HttpServletRequest req) {
        ...
        //マイグループ名
        GSValidateCommon.validateMyGroupName(errors, cmn131name__, req);
        //メモ
        GSValidateCommon.validateMemo(errors, cmn131memo__, req);
//        //メンバー(現在選択中のメンバー(登録時に使用する値))
//        GSValidateCommon.validateMember(errors, cmn131userSid__);
