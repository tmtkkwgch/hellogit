 ...
 * @author JTS
 */
public class Man028knBiz {

    /** Logging インスタンス */
    private static Log log__ = LogFactory.getLog(Man028knBiz.class);
     ...
     */
    public void setImportFileName(Man028knParamModel paramMdl, String tempDir)
        throws SQLException, IOToolsException {

        //取込みCSVファイル名称セット
        String fileName = __getFileName(tempDir);
        paramMdl.setMan028knFileName(fileName);
    }
