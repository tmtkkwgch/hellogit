...
import jp.groupsession.v2.man.man070.Man070ParamModel;

/**
 * <br>[機  能] メイン 管理者設定 プロキシサーバ設定確認画面の情報を保持するModelクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Man070knParamModel extends Man070ParamModel {
