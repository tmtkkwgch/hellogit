...
/**
 * <br>[機  能] アドレス帳 会社一覧画面の検索条件を保持するModelクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Adr100SearchModel extends AbstractModel {
     ...
     * @param coSini coSini
     */
    public void setCoSini(String coSini) {
        coSini__ = coSini;
    }
