...
import jp.groupsession.v2.adr.adr130.Adr130Form;
 ...
 * @author JTS
 */
public class Adr140Form extends Adr130Form {
     ...
     */
    public ActionErrors validateAdr140(Connection con, RequestModel reqMdl) throws SQLException {
        ActionErrors errors = new ActionErrors();
        GsMessage gsMsg = new GsMessage(reqMdl);

        //カテゴリSID
        GSValidateAdr.validateCategoryExist(errors, con, adr140CatSid__);
        //ラベル名
