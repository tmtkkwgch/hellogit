...
<html:html>
<head>
<title>[Group Session] <gsmsg:write key="cmn.entry.position.kn" /></title>
...
<body class="body_03">
<html:form action="/address/adr220kn">

<input type="hidden" name="CMD" value="kakutei">
<html:hidden property="adr210ProcMode" />
<html:hidden property="adr210EditPosSid" />
<html:hidden property="adr210SortRadio" />
<html:hidden property="adr220bikou" />
<html:hidden property="adr220yksName" />

<logic:notEmpty name="adr220knForm" property="adr010selectSid">
<logic:iterate id="adrSid" name="adr220knForm" property="adr010selectSid">
  <input type="hidden" name="adr010selectSid" value="<bean:write name="adrSid" />">
</logic:iterate>
</logic:notEmpty>

<logic:notEmpty name="adr220knForm" property="adr010SearchTargetContact" scope="request">
  <logic:iterate id="target" name="adr220knForm" property="adr010SearchTargetContact" scope="request">
    <input type="hidden" name="adr010SearchTargetContact" value="<bean:write name="target"/>">
  </logic:iterate>
</logic:notEmpty>
<logic:notEmpty name="adr220knForm" property="adr010svSearchTargetContact" scope="request">
  <logic:iterate id="svTarget" name="adr220knForm" property="adr010svSearchTargetContact" scope="request">
...
<td width="100%" align="center">
  ...
  <td>
    ...
    <td width="100%" class="header_white_bg_text">[ <gsmsg:write key="cmn.entry.position.kn" /> ]</td>
  ...
  <td>
    ...
    <td align="left" class="td_type1" width="80%"><bean:write name="adr220knForm" property="adr220yksName" /></td>
    </tr>

    <tr>
    <td class="table_bg_A5B4E1" nowrap><span class="text_bb1"><gsmsg:write key="cmn.memo" /></span></td>
    <td align="left" class="td_type1"><bean:write name="adr220knForm" property="bikou" filter="false" /></td>
    </tr>
    </table>
  ...
  <img src="../common/images/spacer.gif" width="1px" height="10px" border="0" alt="<gsmsg:write key="cmn.spacer" />">
    ...
    <input type="button" value="<gsmsg:write key="cmn.final" />" class="btn_base1" onClick="buttonPush('kakutei');">
    <input type="button" value="<gsmsg:write key="cmn.back" />" class="btn_back_n1" onClick="buttonPush('input_back');"><img src="../common/images/spacer.gif" width="5" height="1" border="0" alt="">
    </td>
    </tr>
    </table>
