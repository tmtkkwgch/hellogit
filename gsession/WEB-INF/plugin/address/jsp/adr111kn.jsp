...
<title>[Group Session] <gsmsg:write key="address.adr111kn.1" /></title>
...
<html:form action="/address/adr111kn">
...
<logic:notEmpty name="adr111knForm" property="adr010searchLabel">
<logic:iterate id="searchLabel" name="adr111knForm" property="adr010searchLabel">
  <input type="hidden" name="adr010searchLabel" value="<bean:write name="searchLabel" />">
</logic:iterate>
</logic:notEmpty>
<logic:notEmpty name="adr111knForm" property="adr010svSearchLabel">
<logic:iterate id="svSearchLabel" name="adr111knForm" property="adr010svSearchLabel">
  <input type="hidden" name="adr010svSearchLabel" value="<bean:write name="svSearchLabel" />">
</logic:iterate>
</logic:notEmpty>

<logic:notEmpty name="adr111knForm" property="adr010selectSid">
<logic:iterate id="adrSid" name="adr111knForm" property="adr010selectSid">
  <input type="hidden" name="adr010selectSid" value="<bean:write name="adrSid" />">
</logic:iterate>
</logic:notEmpty>

<logic:notEmpty name="adr111knForm" property="adr010SearchTargetContact" scope="request">
  <logic:iterate id="target" name="adr111knForm" property="adr010SearchTargetContact" scope="request">
    <input type="hidden" name="adr010SearchTargetContact" value="<bean:write name="target"/>">
  </logic:iterate>
</logic:notEmpty>
<logic:notEmpty name="adr111knForm" property="adr010svSearchTargetContact" scope="request">
  <logic:iterate id="svTarget" name="adr111knForm" property="adr010svSearchTargetContact" scope="request">
...
<logic:notEmpty name="adr111knForm" property="adr020tantoList">
<logic:iterate id="tantoList" name="adr111knForm" property="adr020tantoList">
...
<logic:notEmpty name="adr111knForm" property="adr020label">
<logic:iterate id="label" name="adr111knForm" property="adr020label">
...
<logic:notEmpty name="adr111knForm" property="adr020permitViewGroup">
<logic:iterate id="permitViewGroup" name="adr111knForm" property="adr020permitViewGroup">
  <input type="hidden" name="adr020permitViewGroup" value="<bean:write name="permitViewGroup" />">
</logic:iterate>
</logic:notEmpty>

<logic:notEmpty name="adr111knForm" property="adr020permitViewUser">
<logic:iterate id="permitViewUser" name="adr111knForm" property="adr020permitViewUser">
...
<logic:notEmpty name="adr111knForm" property="adr020permitEditGroup">
<logic:iterate id="permitEditGroup" name="adr111knForm" property="adr020permitEditGroup">
  <input type="hidden" name="adr020permitEditGroup" value="<bean:write name="permitEditGroup" />">
</logic:iterate>
</logic:notEmpty>

<logic:notEmpty name="adr111knForm" property="adr020permitEditUser">
<logic:iterate id="permitEditUser" name="adr111knForm" property="adr020permitEditUser">
...
<logic:notEmpty name="adr111knForm" property="adr110atiList">
<logic:iterate id="atiSid" name="adr111knForm" property="adr110atiList">
...
<logic:notEmpty name="adr111knForm" property="abaListToList">
<logic:iterate id="abaData" name="adr111knForm" property="abaListToList" indexId="idx">
...
<html:hidden property="adr111abaType" />
<html:hidden property="adr111abaName" />
<html:hidden property="adr111abaPostno1" />
<html:hidden property="adr111abaPostno2" />
<html:hidden property="adr111abaTdfk" />
<html:hidden property="adr111abaAddress1" />
<html:hidden property="adr111abaAddress2" />
<html:hidden property="adr111abaBiko" />

<html:hidden name="adr111knForm" property="adr110BackId" />
...
<td width="100%" align="center">
  ...
  <td align="left">
    ...
    <td width="100%" class="header_white_bg_text">[ <gsmsg:write key="address.adr111kn.1" /> ]</td>
    ...
    <td class="header_glay_bg" width="50%">
      <input type="button" value="<gsmsg:write key="cmn.final" />" class="btn_base1" onClick="buttonPush('decisionCompanyBase');">
      <input type="button" class="btn_back_n1" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('backInputCompanyBase');">
    </td>
    ...
    <td valign="middle" align="left" class="td_wt">
      ...
      &nbsp;
      <logic:equal name="adr111knForm" property="adr111knAbaTypeName" value="address.122">
        <gsmsg:write key="address.122" />
      </logic:equal>
      <logic:equal name="adr111knForm" property="adr111knAbaTypeName" value="address.123">
        <gsmsg:write key="address.123" />
      </logic:equal>
      <logic:equal name="adr111knForm" property="adr111knAbaTypeName" value="address.124">
        <gsmsg:write key="address.124" />
      </logic:equal>
      &nbsp;&nbsp;&nbsp;&nbsp;<bean:write name="adr111knForm" property="adr111abaName" />
      </span>
    </td>
    </tr>
    ...
    <td valign="middle" align="left" class="td_wt">
    <logic:notEmpty name="adr111knForm" property="adr111abaPostno1">
    <span class="text_base">〒<bean:write name="adr111knForm" property="adr111abaPostno1" />-<bean:write name="adr111knForm" property="adr111abaPostno2" /></span>
    </logic:notEmpty>
    </td>
    </tr>
    ...
    <td valign="middle" align="left" class="td_wt">
      <span class="text_base"><bean:write name="adr111knForm" property="adr111knAbaTdfkName" /></span>
    </td>
    </tr>
    ...
    <td valign="middle" align="left" class="td_wt">
      <span class="text_base"><bean:write name="adr111knForm" property="adr111abaAddress1" /></span>
    </td>
    </tr>
    ...
    <td valign="middle" align="left" class="td_wt">
      <span class="text_base"><bean:write name="adr111knForm" property="adr111abaAddress2" /></span>
    </td>
    </tr>
    ...
    <td valign="middle" align="left" class="td_wt">
      <span class="text_base"><bean:write name="adr111knForm" property="adr111knViewBiko" filter="false" /></span>
    </td>
    </tr>
    </table>
  </td>
