...
<td width="100%" align="center">
  ...
  <logic:equal name="adr290Form" property="adr280ProcMode" value="<%= kbnFlg %>">
    ...
    <input type="button" value="<gsmsg:write key="cmn.back" />" class="btn_back_n1" onClick="buttonPush('adr290back');">
    </td>
  ...
  <td>
    ...
    <html:text maxlength="20" property="adr290CategoryName" styleClass="text_base" style="width:277px;" />
    </td>
    </tr>
    ...
    <textarea name="adr290bikou" style="width:566px" rows="5" styleClass="text_gray" onkeyup="showLengthStr(value, <%= maxLengthBiko %>, 'inputlength');" id="inputstr"><bean:write name="adr290Form" property="adr290bikou" /></textarea>
    <br>
