...
<td width="100%" align="center">
  ...
  <td align="left">
    ...
    <td width="30%" valign="top" align="left" class="td_wt" rowspan="5">
      <logic:notEmpty name="adr020knForm" property="adr020knTantoNameList">
      <span class="text_base">
      <logic:iterate id="tantoName" name="adr020knForm" property="adr020knTantoNameList">
      <bean:write name="tantoName" /><br>
      </logic:iterate>
      </span>
      </logic:notEmpty>
    </td>
