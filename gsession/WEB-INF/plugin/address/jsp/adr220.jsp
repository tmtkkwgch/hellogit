...
<html:form action="/address/adr220">
<input type="hidden" name="CMD" value="ok">
<input type="hidden" name="helpPrm" value="<bean:write name="adr220Form" property="adr210ProcMode" />">
<html:hidden property="adr210ProcMode" />
<html:hidden property="adr210EditPosSid" />
<html:hidden property="adr210SortRadio" />

<logic:notEmpty name="adr220Form" property="adr010selectSid">
<logic:iterate id="adrSid" name="adr220Form" property="adr010selectSid">
  <input type="hidden" name="adr010selectSid" value="<bean:write name="adrSid" />">
</logic:iterate>
</logic:notEmpty>

<logic:notEmpty name="adr220Form" property="adr010SearchTargetContact" scope="request">
  <logic:iterate id="target" name="adr220Form" property="adr010SearchTargetContact" scope="request">
    <input type="hidden" name="adr010SearchTargetContact" value="<bean:write name="target"/>">
  </logic:iterate>
</logic:notEmpty>
<logic:notEmpty name="adr220Form" property="adr010svSearchTargetContact" scope="request">
  <logic:iterate id="svTarget" name="adr220Form" property="adr010svSearchTargetContact" scope="request">
...
<td width="100%" align="center">
  ...
  <td>
    ...
    <td width="100%" class="header_white_bg_text">[ <gsmsg:write key="cmn.entry.position" /> ]</td>
    ...
    <logic:equal name="adr220Form" property="adr210ProcMode" value="<%= edit %>">
  ...
  <td>
    ...
    <tr>
    <td class="table_bg_A5B4E1" width="20%" nowrap><span class="text_bb1"><gsmsg:write key="cmn.job.title" /></span><span class="text_r2">※</span></td>
    <td align="left" class="td_wt" width="80%">
    <html:text maxlength="30" property="adr220yksName" styleClass="text_base" style="width:277px;" />
    </td>
    </tr>
    ...
    <textarea name="adr220bikou" style="width:566px" rows="5" styleClass="text_gray" onkeyup="showLengthStr(value, <%= maxLengthBiko %>, 'inputlength');" id="inputstr"><bean:write name="adr220Form" property="adr220bikou" /></textarea>
    <br>
  ...
  <img src="../common/images/spacer.gif" width="1px" height="10px" border="0" alt="<gsmsg:write key="cmn.spacer" />">
    ...
    <input type="button" value="<gsmsg:write key="cmn.back" />" class="btn_back_n1" onClick="buttonPush('list_back');"><img src="../common/images/spacer.gif" width="5" height="1" border="0" alt="">
    </td>
    </tr>
    </table>
