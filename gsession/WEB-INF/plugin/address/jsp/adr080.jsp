...
<title>[Group Session] <gsmsg:write key="address.adr080.1" /></title>
<script language="JavaScript" src="../common/js/cmd.js?<%= GSConst.VERSION_PARAM %>"></script>
<script language="JavaScript" src="../address/js/adr080.js?<%= GSConst.VERSION_PARAM %>"></script>
</head>
...
<td width="100%" align="center">
  ...
  <td>
    ...
    <td width="100%" class="header_white_bg_text">[ <gsmsg:write key="address.adr080.1" /> ]</td>
    ...
    <input type="button" name="btn_add" class="btn_add_n1" value="<gsmsg:write key="cmn.add" />" onClick="return buttonSubmit('adr080add', '<%= add %>', '-1');">
    <input type="button" name="btn_back" class="btn_back_n1" value="<gsmsg:write key="cmn.back" />" onClick="return buttonPush('adr080back');">
    </td>
    ...
    <tr>
    <td>
    <input type="button" class="btn_base0" value="<gsmsg:write key="cmn.up" />" name="btn_upper" onClick="return buttonPush('adr080up');">
    <input type="button" class="btn_base0" value="<gsmsg:write key="cmn.down" />" name="btn_downer" onClick="return buttonPush('adr080down');">&nbsp;&nbsp;<span class="text_base"><gsmsg:write key="address.adr080.2" /></span>
    </td>
    </tr>
    </table>
    ...
    <th align="center" class="table_bg_7D91BD" width="25%"><span class="text_tlw"><gsmsg:write key="address.101" /></span></th>
    ...
    <td align="left">
    <a href="javascript:void(0);" onclick="return buttonSubmit('adr080edit', '<%= edit %>', '<bean:write name="gyoMdl" property="atiSid" />');">
    <span class="text_link"><bean:write name="gyoMdl" property="atiName" /></span>
    </a>
    </td>
