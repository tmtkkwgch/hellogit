...
<body class="body_03">
<html:form action="/address/adr140kn">

<input type="hidden" name="CMD" value="ok">
<html:hidden property="adr130ProcMode" />
<html:hidden property="adr130EditAlbSid" />
<html:hidden property="adr130SortRadio" />
<html:hidden property="adr140albName" />
<html:hidden property="adr140bikou" />
<html:hidden property="adr280EditSid" />
<html:hidden property="adr140CatSid" />
<html:hidden property="adr140knDelCatName" />


<logic:notEmpty name="adr140knForm" property="adr010selectSid">
<logic:iterate id="adrSid" name="adr140knForm" property="adr010selectSid">
  <input type="hidden" name="adr010selectSid" value="<bean:write name="adrSid" />">
</logic:iterate>
</logic:notEmpty>

<logic:notEmpty name="adr140knForm" property="adr010SearchTargetContact" scope="request">
  <logic:iterate id="target" name="adr140knForm" property="adr010SearchTargetContact" scope="request">
    <input type="hidden" name="adr010SearchTargetContact" value="<bean:write name="target"/>">
  </logic:iterate>
</logic:notEmpty>
<logic:notEmpty name="adr140knForm" property="adr010svSearchTargetContact" scope="request">
  <logic:iterate id="svTarget" name="adr140knForm" property="adr010svSearchTargetContact" scope="request">
...
<td width="100%" align="center">
  ...
  <td>
    ...
    <td align="left" class="td_type1" width="80%"><bean:write name="adr140knForm" property="catName" /></td>
    </tr>

    <tr>
    <td class="table_bg_A5B4E1" width="20%" nowrap><span class="text_bb1"><gsmsg:write key="cmn.label.name" /></span></td>
    <td align="left" class="td_type1" width="80%"><bean:write name="adr140knForm" property="adr140albName" /></td>
    </tr>

    <tr>
    <td class="table_bg_A5B4E1" nowrap><span class="text_bb1"><gsmsg:write key="cmn.memo" /></span></td>
    <td align="left" class="td_type1"><bean:write name="adr140knForm" property="bikou" filter="false" /></td>
    </tr>
    </table>
