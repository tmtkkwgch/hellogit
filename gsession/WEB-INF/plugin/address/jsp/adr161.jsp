...
<td width="100%" align="center">
  ...
  <td align="left">
    ...
    <input type="button" value="<gsmsg:write key="cmn.edit" />" class="btn_edit_n1" onClick="buttonPush('edit');">
    <input type="button" value="<gsmsg:write key="cmn.back" />" class="btn_back_n1" onClick="buttonPush('adr161_back');">
    </td>
  ...
  <td>
    ...
    <td valign="middle" align="left" class="td_wt">
      <span class="text_base">
        <bean:write name="adr161Form" property="adr161ContactUserComName" />
        <logic:notEmpty name="adr161Form" property="adr161ContactUserComName">&nbsp;&nbsp;</logic:notEmpty>
    ...
    <td valign="middle" align="left" class="td_wt">
      <span class="text_base"><bean:write name="adr161Form" property="adr161title" /></span>
    </td>
    </tr>
...
&nbsp;<gsmsg:write key="tcd.153" />&nbsp;
    ...
    <td align="left" class="td_wt">
    <logic:empty name="adr161Form" property="tmpFileList" scope="request">&nbsp;</logic:empty>
