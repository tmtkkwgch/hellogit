...
<td width="100%" align="center">
  ...
  <td align="left">
    ...
    <td align="left">
    <dl class="decorate_textbox1">
    <dt><a href="#" onClick="return buttonPush('powedit');"><span class="text_link"><gsmsg:write key="cmn.setting.permissions" /></span></a></dt>
    <dd><div class="text"><li><gsmsg:write key="address.adr030.1" /></li></div></dd>
    </dl>
    </td>
    </tr>
    </table>
