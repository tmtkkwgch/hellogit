...
/**
 * <br>[機  能] ファイルのロックを行うWEBAPIアクション
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class ApiFileLockAction extends AbstractApiAction {
    /** Logging インスタンス */
    private static Log log__ = LogFactory.getLog(ApiFileLockAction.class);
    ...
    public Document createXml(ActionForm form, HttpServletRequest req,
        ...
        ApiFileLockForm thisForm = (ApiFileLockForm) form;
        ...
        try {
            ...
            //カレント情報取得
            fileBiz.updateLockKbn(dirSid, version, GSConstFile.LOCK_KBN_ON, usrSid, con);

            commitFlg = true;
        } catch (SQLException e) {
            log__.error("ファイルロックに失敗", e);
            throw e;
