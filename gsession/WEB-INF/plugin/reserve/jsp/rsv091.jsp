...
<body class="body_03">
<html:form action="/reserve/rsv091">
...
<logic:notEmpty name="rsv091Form" property="rsv100CsvOutField" scope="request">
  <logic:iterate id="csvOutField" name="rsv091Form" property="rsv100CsvOutField" scope="request">
    <input type="hidden" name="rsv100CsvOutField" value="<bean:write name="csvOutField"/>">
  </logic:iterate>
</logic:notEmpty>

<logic:notEmpty name="rsv091Form" property="rsvIkkatuTorokuKey" scope="request">
  <logic:iterate id="key" name="rsv091Form" property="rsvIkkatuTorokuKey" scope="request">
    ...
    <table class="tl0" cellpadding="5" cellspacing="0" border="0" width="100%">
      ...
      <td align="left" class="td_wt table_pad">
        ...
        <td width="0%" align="left" valign="top" nowrap>
          <html:select property="rsv091selectFiles" styleClass="select01" multiple="true" size="5">
            <html:optionsCollection name="rsv091Form" property="rsv091FileLabelList" value="value" label="label" />
          </html:select>
        </td>
        <td width="0%" align="left" valign="top" nowrap><img src="../common/images/spacer.gif" width="10px" height="1px" border="0"></td>
        <td width="100%" align="left" valign="middle">
          <input type="button" class="btn_attach" value="<gsmsg:write key="cmn.attached" />" name="attacheBtn" onClick="opnTempPlus('rsv091selectFiles', '<bean:write name="rsv091Form" property="rsv010pluginId" />', '0', '6', 'upSisetuImgRsv091');">
          &nbsp;
