...
/**
 * <br>[機  能] 施設予約 管理者設定 自動データ削除設定画面のアクションクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Rsv120Action extends AbstractReserveAction {

    /** Logging インスタンス */
    private static Log log__ = LogFactory.getLog(Rsv120Action.class);
    ...
    */
    public ActionForward executeAction(ActionMapping map,
        ...
        Rsv120Form rsvform = (Rsv120Form) form;
    ...
    private ActionForward __doInit(ActionMapping map,
        ...
        Rsv120Biz biz = new Rsv120Biz(con, getRequestModel(req));
