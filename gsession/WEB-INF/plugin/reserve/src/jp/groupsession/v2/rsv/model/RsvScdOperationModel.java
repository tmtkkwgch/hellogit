...
/**
 * <br>[機  能] 施設予約プラグインからスケジュールクラスを操作するための情報を格納するModelクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
...
public class RsvScdOperationModel extends AbstractModel {
    ...
    /** ユーザ名 */
    private String scdUserName__ = null;
    ...
    /**
     * <p>get SCE_MONTH_YEARLY value
     * @return SCE_MONTH_YEARLY value
     */
    ...
    /**
     * <p>set SCE_MONTH_YEARLY value
     * @param sceMonthOfYearly SCE_MONTH_YEARLY value
     */
    ...
    /**
     * <p>set SCE_DAY_YEARLY value
     * @param sceDayOfYearly SCE_DAY_YEARLY value
     */
    public void setSceDayOfYearly(int sceDayOfYearly) {
        sceDayOfYearly__ = sceDayOfYearly;
    }
    /**
     * <p>get SCE_DAY_YEARLY value
     * @return SCE_DAY_YEARLY value
     */
