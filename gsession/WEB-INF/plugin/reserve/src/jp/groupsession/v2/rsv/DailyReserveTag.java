 ...
 * @author JTS
 * @version $Revision: 1.3 $ $Date: 2015/09/11 09:19:28 $
 */
public class DailyReserveTag extends TagSupport {
    ...
    private void __writeHtmlString(
        ...
        writer.println("<td class=\"td_type1\" id=\"" + key + "\" rowspan=\"" + rowspan + "\">");

        if (sisetuMdl.getRacAuth() != GSConstReserve.RSV_ACCESS_KBN_READ) {

            if (checkedFlg) {
                writer.println("<input type=\"checkbox\" name=\"rsvIkkatuTorokuKey\""
...
//                    + " name=\"sisetuImg" + sisetuMdl.getSisetuImgBinSid() + "\""
                    ...
                    + " border=\"1\""
                    + " class=\"img_hoge\" width=\"50\" >");
        }

        writer.println("  <div style=\"height:3px;\">");
        ...
        writer.println("<a href=\"#\" name=\"deluserBtn\" onClick=\"moveGekkanSchedule('"
                ...
                + " width=\"35\" height=\"18\" alt=\"\" border=\"0\">"
                + "<span class=\"rsv_link_gek\">"
        ...
        if (sisetuMdl.getRsdInfoSisetuIdDspKbn() == GSConstReserve.SISETU_DATA_DSP_ON
            ...
            writer.println("  <span class=\"text_base_rsv2\">"
                    + gsMsg.getMessage(req, "reserve.55")
                    + ":"
                    + "</span><span class=\"text_base_rsv\">"
        ...
        if (sisetuMdl.getRsdInfoBikoDspKbn() == GSConstReserve.SISETU_DATA_DSP_ON
            ...
            writer.println(
                    "<div>"
                    + "<div class=\"text_base_rsv2  display_table_cell nowrap\">"
                    + gsMsg.getMessage(req, "cmn.memo")
                    + ":</div>"
                    + "<div class=\"text_base_rsv display_table_cell\">"
        ...
        if (sisetuMdl.getRacAuth() == GSConstReserve.RSV_ACCESS_KBN_READ) {
            ...
            writer.println("<td class=\"td_type1\" rowspan=\"" + rowspan + "\""
                    ...
                    + sisetuMdl.getRsdSid()
                    + "');\">"
                    + "<img src=\"../reserve/images/scadd.gif\""
            ...
            for (int j = 0; j < valueList.size(); j++) {
                ...
                if (yrkMdl != null) {
                    ...
                    if (!StringUtil.isNullZeroStringSpace(yrkMdl.getYrkRiyoDateStr())) {
                        writer.println("  <span class=\"" + mokApprStatus[0] + "\">");
                    ...
                    writer.println("  <div id=\"rvtext_"
                            + tipsKey + "\" style=\"display:none;padding: 5px;margin: 5px;"
                            + "background-color: #eeeeee;border: solid 1px #cccccc;font-size: 12px;"
                            + "white-space:nowrap;\">");
