...
/**
 * <br>[機  能] 施設予約設定ファイル(reserve.conf)の読み込みを行う
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class RsvConfigBundle {

    /** 設定ファイル名 */
    private static final String CONF_FILENAME__ = "reserve.conf";

    /** Logging インスタンス */
    private static Log log__ = LogFactory.getLog(RsvConfigBundle.class);
