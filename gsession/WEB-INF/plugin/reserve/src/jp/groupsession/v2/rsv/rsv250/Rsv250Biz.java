...
/**
 * <br>[機  能] 施設予約 管理者設定 施設予約インポート画面のビジネスロジッククラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Rsv250Biz {

    /** Logging インスタンス */
    private static Log log__ = LogFactory.getLog(Rsv250Biz.class);
    /** リクエスト情報 */
     ...
     * @param con コネクション
     */
    public Rsv250Biz(RequestModel reqMdl, Connection con) {
        reqMdl_ = reqMdl;
        con_ = con;
    }
     ...
     * <br>[備  考]
     *
     * @param paramMdl Rsv250ParamModel
     * @param tempDir テンポラリディレクトリパス
     * @throws SQLException SQL実行例外
     * @throws IOToolsException ファイルアクセス時例外
     */
    public void setInitData(Rsv250ParamModel paramMdl, String tempDir)
        ...
        paramMdl.setRsv250FileLabelList(fileLblList);
    }
}