...
/**
 * <br>[機  能] 施設予約 個人設定 日間表示時間帯設定確認画面のアクションクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Rsv160knAction extends AbstractReserveAction {

    /** Logging インスタンス */
    private static Log log__ = LogFactory.getLog(Rsv160knAction.class);
    ...
    */
    public ActionForward executeAction(ActionMapping map,
        ...
        Rsv160knForm rsvform = (Rsv160knForm) form;
        ...
        //確定ボタン押下
        if (cmd.equals("zikantai_settei_kakutei")) {
            log__.debug("確定ボタン押下");
            forward = __doKakutei(map, rsvform, req, res, con);
        //戻るボタン押下
        } else if (cmd.equals("back_to_zikantai_settei_input")) {
            log__.debug("戻るボタン押下");
            forward = map.findForward("back_to_zikantai_settei_input");
        //初期表示処理
        } else {
            log__.debug("初期表示処理");
    ...
    private ActionForward __doInit(ActionMapping map,
                                    ...
                                    HttpServletResponse res,
                                    Connection con) throws Exception {
        Rsv160knBiz biz = new Rsv160knBiz(con, getRequestModel(req));

        Rsv160knParamModel paramMdl = new Rsv160knParamModel();
     ...
     * @throws Exception 実行時例外
     */
    public ActionForward __doKakutei(ActionMapping map, Rsv160knForm form,
        ...
        try {
            ...
            Rsv160knParamModel paramMdl = new Rsv160knParamModel();
            paramMdl.setParam(form);
            biz.registDate(paramMdl, getSessionUserModel(req).getUsrsid());
            paramMdl.setFormData(form);
