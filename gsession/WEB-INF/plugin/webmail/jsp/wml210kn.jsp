...
<html:form action="/webmail/wml210kn">
...
<html:hidden property="wml210LabelName" />
<html:hidden property="wml210initKbn" />
<html:hidden property="wml200SortRadio" />
...
<td width="100%" align="center">
  ...
  <td>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
      <tr>
        ...
        <td width="100%" class="header_ktool_bg_text2">[ <gsmsg:write key="cmn.entry.label.kn" /> ]</td>
  ...
  <td>
    ...
    <td align="left" class="td_wt" width="70%">
      <bean:write name="wml210knForm" property="wml200accountName" />
    </td>
    </tr>
    <tr>
    <td class="table_bg_A5B4E1" width="30%" nowrap><span class="text_bb1"><gsmsg:write key="wml.74" /></span></td>
    <td align="left" class="td_wt" width="70%"><bean:write name="wml210knForm" property="wml210LabelName" /></td>
    </tr>
    </table>
