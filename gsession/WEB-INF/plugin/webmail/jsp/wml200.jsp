...
<title>[Group Session] <gsmsg:write key="wml.wml110.01" /></title>
  ...
  <script language="JavaScript" src="../webmail/js/wml200.js?<%= GSConst.VERSION_PARAM %>"></script>
</head>
...
<td width="100%" align="center">
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
      <tr>
        ...
        <td class="header_glay_bg" width="50%">
          ...
          <input type="button" name="btn_facilities_mnt" class="btn_back_n1" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('wml030Back');">
        </td>
  ...
  <tr><td>
    ...
    <logic:iterate id="lbnData" name="wml200Form" property="lbnList" indexId="idx">
      ...
      <tr>
      <td align="center" class="smail_td1" nowrap><html:radio property="wml200SortRadio" value="<%= String.valueOf(lbValue) %>" styleId="<%= labelCheckId %>" /></td>
