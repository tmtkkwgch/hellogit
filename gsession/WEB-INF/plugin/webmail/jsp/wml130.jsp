...
<title>[Group Session] <gsmsg:write key="wml.86" /></title>
  ...
  <script language="JavaScript" src="../webmail/js/wml130.js?<%= GSConst.VERSION_PARAM %>"></script>
</head>
  ...
  <tr><td>
    ...
    <td align="left" class="smail_td1" width="100%">
      <logic:notEmpty name="wml130Form" property="acntList">
        <html:select property="wml130accountSid" size="1" onchange="changeAccountCombo();" style="width:100%;">
    ...
    <logic:iterate id="filData" name="wml130Form" property="filList" indexId="idx">
      ...
      <tr>
      <td align="center" class="smail_td1" nowrap><html:radio property="wml130SortRadio" value="<%= String.valueOf(filValue) %>" styleId="<%= filterCheckId %>" /></td>
      <td align="left" class="smail_td1" onClick="wml130CheckFilter('<%= filterCheckId %>');">
