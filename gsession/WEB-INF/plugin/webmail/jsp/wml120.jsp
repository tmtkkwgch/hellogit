...
<html:form action="/webmail/wml120">
...
<td width="100%" align="center">
  ...
  <td>
    ...
    <td align="left" class="td_wt" width="70%">
      <bean:write name="wml120Form" property="wml110account" />
    </td>
    </tr>
    <tr>
    <td class="table_bg_A5B4E1" width="30%" nowrap><span class="text_bb1"><gsmsg:write key="wml.74" /></span></td>
    <td align="left" class="td_wt" width="70%">
      <html:text name="wml120Form" property="wml120LabelName" maxlength="100" style="width:544px;" />
    </td>
    </tr>
    </table>
