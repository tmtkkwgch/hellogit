...
<td width="100%" align="center">
  ...
  <td>
    ...
    <td class="td_type1">
      <input type="button" class="btn_attach" value="<gsmsg:write key="cmn.attached" />" name="attacheBtn" onClick="opnTemp('wml160selectFiles', '<bean:write name="wml160Form" property="wml160pluginId" />', '1', '0');">
      &nbsp;<input type="button" class="btn_delete" value="<gsmsg:write key="cmn.delete" />" name="dellBtn" onClick="buttonPush('deleteFile');"><br>
      <html:select property="wml160selectFiles" styleClass="select01" multiple="false" size="1">
        <html:optionsCollection name="wml160Form" property="wml160FileLabelList" value="value" label="label" />
      </html:select><br>
    ...
    <tr>
    <td class="table_bg_A5B4E1" width="25%"><span class="text_bb1"><gsmsg:write key="cmn.overwrite" /></span><span class="text_r2"><gsmsg:write key="cmn.comments" /></span></td>
