...
import jp.groupsession.v2.wml.wml250.Wml250ParamModel;


/**
 * <br>[機  能] WEBメール メールテンプレート登録確認画面のパラメータ情報を保持するModelクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Wml250knParamModel extends Wml250ParamModel {
