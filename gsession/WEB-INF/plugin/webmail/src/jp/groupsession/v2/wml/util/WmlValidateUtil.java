    ...
    public static boolean isAsciiOrNumber(String input) {
        ...
        for (int i = 0; i < c.length; i++) {
            ...
            if (!StringUtil.isAscii(c[i])) {
                //数値判定
                if (!WmlValidateUtil.isNumber(String.valueOf(c[i]))) {
                    ret = false;
                    break;
                }
            }
...
//        }
    ...
    public static boolean validateTextField(
        ...
        //タブ文字チェック
        if (!__validateTab(errors, value, paramName, paramNameJpn)) {
            return false;
        }
     ...
     * @return 入力チェック結果 true : 正常 false : 不正
     */
    private static boolean __validateTab(
                                ActionErrors errors,
                                String value,
                                String paramName,
                                String paramNameJpn) {
