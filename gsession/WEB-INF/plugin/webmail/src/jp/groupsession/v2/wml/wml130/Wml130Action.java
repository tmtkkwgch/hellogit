...
/**
 * <br>[機  能] WEBメール フィルタ設定画面のアクションクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Wml130Action extends AbstractWebmailAction {

    /** Logging インスタンス */
    private static Log log__ = LogFactory.getLog(Wml130Action.class);
    ...
    public ActionForward executeAction(ActionMapping map, ActionForm form,
        ...
        Wml130Form thisForm = (Wml130Form) form;
     ...
     */
    public ActionForward __doInit(ActionMapping map, Wml130Form form,
            HttpServletRequest req, HttpServletResponse res, Connection con)
            throws Exception {
        ...
        Wml130ParamModel paramMdl = new Wml130ParamModel();
        paramMdl.setParam(form);
        Wml130Biz biz = new Wml130Biz();
     ...
     * @throws Exception 実行時例外
     */
    public ActionForward __doConfig(ActionMapping map, Wml130Form form,
            HttpServletRequest req, HttpServletResponse res, Connection con)
            throws Exception {
...
//        String msg = biz.getDeletePosMsg(con, form.getAdr080EditAtiSid(), msgRes);
        ...
        cmn999Form.addHiddenParam("wml130accountSid", form.getWml130accountSid());
        cmn999Form.addHiddenParam("wml130SortRadio", form.getWml130SortRadio());
