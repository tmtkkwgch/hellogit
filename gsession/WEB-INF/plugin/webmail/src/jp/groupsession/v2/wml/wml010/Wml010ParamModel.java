...
import jp.groupsession.v2.wml.model.WmlParamModel;
...
/**
 * <br>[機  能] WEBメール メール一覧画面のパラメータ情報を保持するModelクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Wml010ParamModel extends WmlParamModel {
    /** プラグイン 使用不可 */
    ...
    /** 送信先 選択 */
    public static final int DESTINATION_SELECT = 1;
    ...
    /** 送信メール 送信予約 */
    private int sendMailPlanType__ = 0;
    /** 送信メール 送信予定日時 年 */
     ...
     * @param form フォーム
     */
    public Wml010ParamModel(Wml010Form form) {
        setParam(form);
    }
