...
import jp.groupsession.v2.wml.wml130.Wml130Form;
...
/**
 * <br>[機  能] WEBメール フィルタ登録画面のフォーム
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Wml140Form extends Wml130Form {
    ...
    public ActionErrors validateCheck(HttpServletRequest req) throws Exception {
        ...
        //フィルター名入力チェック
        GSValidateWebmail.validateTextBoxInput(errors, wml140FilterName__,
                "wml140FilterName",
                getInterMessage(req, GSConstWebmail.TEXT_FILTER),
                GSConstWebmail.MAXLEN_SEARCH_KEYWORD, true);

        //条件未選択
        if (wml140condition1__ == null
            && wml140condition2__ == null
            && wml140condition3__ == null
            && wml140condition4__ == null
            && wml140condition5__ == null
            && wml140tempFile__.equals("0")) {
            ...
            StrutsUtil.addMessage(
                    errors, msg, "wml140condition." + msgKey);
        ...
        //転送先メールアドレスチェック
        if (!(wml140actionSend__.equals("0"))) {
            List<String> addressList = new ArrayList<String>();
            for (int sendNo = 0; sendNo < wml140actionSendValue__.length; sendNo++) {
                String fwAddress = wml140actionSendValue__[sendNo];
                boolean errorFlg = GSValidateWebmail.validateMailTextBoxInput(
                            errors,
                            fwAddress,
                            "wml140actionSendValue" + sendNo,
                ...
                if (!errorFlg) {
                    ...
                    if (dupIndex >= 0) {
                        ...
                        StrutsUtil.addMessage(
                                errors, msg, "wml140actionSendValue." + sendNo + msgKey);
                    }
        ...
        //ラベル選択チェック
        if (wml140actionLabel__.equals("1")
                && wml140actionLabelValue__.equals("-1")) {
            String msgKey = "error.select.required.text";
            ActionMessage msg = new ActionMessage(msgKey,
                    getInterMessage(req, GSConstWebmail.TEXT_SEL_LABEL));
            StrutsUtil.addMessage(
                    errors, msg, "wml140selLabel." + msgKey);
        }
        return errors;
    }
    ...
    public void validateCondition(ActionErrors errors, HttpServletRequest req) {
        ...
        //条件チェック
        errSize = conditionCheck(wml140condition1__, wml140conditionText1__,
                errSize, errors, getInterMessage(req, GSConstWebmail.TEXT_CONDITION1));
        errSize = conditionCheck(wml140condition2__, wml140conditionText2__,
                errSize, errors, getInterMessage(req, GSConstWebmail.TEXT_CONDITION2));
        errSize = conditionCheck(wml140condition3__, wml140conditionText3__,
                errSize, errors, getInterMessage(req, GSConstWebmail.TEXT_CONDITION3));
        errSize = conditionCheck(wml140condition4__, wml140conditionText4__,
                errSize, errors, getInterMessage(req, GSConstWebmail.TEXT_CONDITION4));
        errSize = conditionCheck(wml140condition5__, wml140conditionText5__,
