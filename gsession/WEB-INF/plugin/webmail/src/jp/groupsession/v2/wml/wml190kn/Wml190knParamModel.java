...
import jp.groupsession.v2.wml.wml190.Wml190ParamModel;

/**
 * <br>[機  能] WEBメール 個人設定 アカウント編集確認画面のパラメータ情報を保持するModelクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Wml190knParamModel extends Wml190ParamModel {
    /** テーマ 表示用 */
