...
public class Wml200Biz {
    ...
    public void setInitData(Connection con,
        ...
        Wml200Dao dao = new Wml200Dao(con);
        List<LabelDataModel> ldMdlList = dao.getLabelList(selectWacSid);
     ...
     * @throws SQLException SQL実行時例外
     */
    public void updateSort(Connection con, Wml200ParamModel paramMdl, int changeKbn)
        throws SQLException {
        ...
        //ラジオ選択値取得
        String selectedKey = paramMdl.getWml200SortRadio();
        ...
        //新しいキーを設定
        paramMdl.setWml200SortRadio(__getRadioValueStr(motoSid, newSort, target));
    }
}
