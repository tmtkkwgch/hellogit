...
/**
 * <br>[機  能] WEBメール設定ファイル(webmail.conf)の読み込みを行う
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class WmlConfigBundle {

    /** 設定ファイル名 */
    private static final String CONF_FILENAME__ = "webmail.conf";

    /** Logging インスタンス */
    private static Log log__ = LogFactory.getLog(WmlConfigBundle.class);
