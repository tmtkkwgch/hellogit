...
import jp.groupsession.v2.anp.anp060kn.Anp060knParamModel;


/**
 * <br>[機  能] メッセージ配信確認 送信者一覧(ポップアップ画面)のパラメータモデル
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Anp160ParamModel extends Anp060knParamModel {
