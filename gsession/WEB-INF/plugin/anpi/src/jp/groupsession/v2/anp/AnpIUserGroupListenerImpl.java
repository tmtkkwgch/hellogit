 ...
 * <br>[解  説] 安否確認についての処理を行う
 * <br>[備  考]
 *
 * @author JTS
 */
public class AnpIUserGroupListenerImpl implements IUserGroupListener {
    ...
    public void addUser(MlCountMtController cntCon,
            Connection con, int usid, int eusid, RequestModel reqMdl) throws SQLException {

        //安否確認個人設定を作成(デフォルトで)
        AnpiCommonBiz cbiz = new AnpiCommonBiz();

        //DBに追加
        cbiz.getNewAnpPriConfModel(con, usid);
    ...
    public void addGroup(
            Connection con, int gsid, int eusid) throws SQLException {
    }
