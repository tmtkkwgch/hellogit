...
/**
 * <br>[機  能] 安否状況一覧画面のフォーム
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Anp010Form extends AbstractGsForm {
    ...
    public void saveSearchParm() {
        anp010SvSearchSndKbn__ = anp010SearchSndKbn__;
        anp010SvSearchAnsKbn__ = anp010SearchAnsKbn__;
        anp010SvSearchAnpKbn__ = anp010SearchAnpKbn__;
        anp010SvSearchPlcKbn__  = anp010SearchPlcKbn__;
        anp010SvSearchSyuKbn__ = anp010SearchSyuKbn__;
    }
     ...
     */
    public void setHiddenParamAnp010(Cmn999Form cmn999Form) {

        cmn999Form.addHiddenParam("backScreen", backScreen__);
        cmn999Form.addHiddenParam("anpiSid", anpiSid__);
        cmn999Form.addHiddenParam("anp010SelectGroupSid", anp010SelectGroupSid__);
        cmn999Form.addHiddenParam("anp010NowPage", anp010NowPage__);
        cmn999Form.addHiddenParam("anp010SortKeyIndex", anp010SortKeyIndex__);
        cmn999Form.addHiddenParam("anp010OrderKey", anp010OrderKey__);

        cmn999Form.addHiddenParam("anp010SearchKbn", anp010SearchKbn__);
        cmn999Form.addHiddenParam("anp010SearchSndKbn", anp010SearchSndKbn__);
        cmn999Form.addHiddenParam("anp010SearchAnsKbn", anp010SearchAnsKbn__);
        cmn999Form.addHiddenParam("anp010SearchAnpKbn", anp010SearchAnpKbn__);
        cmn999Form.addHiddenParam("anp010SearchPlcKbn", anp010SearchPlcKbn__);
        cmn999Form.addHiddenParam("anp010SearchSyuKbn", anp010SearchSyuKbn__);
        cmn999Form.addHiddenParam("anp010SvSearchSndKbn", anp010SvSearchSndKbn__);
        cmn999Form.addHiddenParam("anp010SvSearchAnsKbn", anp010SvSearchAnsKbn__);
        cmn999Form.addHiddenParam("anp010SvSearchAnpKbn", anp010SvSearchAnpKbn__);
        cmn999Form.addHiddenParam("anp010SvSearchPlcKbn", anp010SvSearchPlcKbn__);
        cmn999Form.addHiddenParam("anp010SvSearchSyuKbn", anp010SvSearchSyuKbn__);
