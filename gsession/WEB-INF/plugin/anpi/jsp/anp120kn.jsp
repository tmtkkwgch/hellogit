...
<td width="100%" align="center">
  ...
  <td align="center">
    ...
    <td width="100%" class="header_ktool_bg_text2">[ <gsmsg:write key="anp.plugin"/> <gsmsg:write key="anp.anp120kn.01"/> ]</td>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <td class="header_glay_bg" width="50%">
            <input type="button" value="<gsmsg:write key="cmn.final" />" class="btn_base1" onClick="buttonPush('anp120knexcute');">
            <input type="button" value="<gsmsg:write key="cmn.back" />" class="btn_back_n1" onClick="buttonPush('anp120knback');">
        </td>
    ...
    <table cellpadding="10" cellspacing="0" border="0" width="100%" class="tl_u2">
        ...
        <tr>
            <td width="20%" valign="middle" align="left" class="table_bg_A5B4E1" nowrap><span class="text_bb1"><gsmsg:write key="cmn.name2"/></span></td>
            <td width="80%" valign="middle" align="left" class="td_wt table_pad" ><span class="text_base"><bean:write name="anp120knForm" property="anp110SelectUserNm"/></span></td>
        </tr>
        ...
        <tr>
            ...
            <span class="text_base"><bean:write name="anp120knForm" property="anp120MailAdr"/></span>
            </td>
        </tr>
        ...
        <tr>
            ...
            <span class="text_base"><bean:write name="anp120knForm" property="anp120TelNo"/></span>
            </td>
        </tr>
