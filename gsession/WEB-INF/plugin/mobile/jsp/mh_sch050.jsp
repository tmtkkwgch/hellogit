...
<body>
<html:form action="/mobile/mh_sch050">
...
<b><%= emojiTokei.toString() %><gsmsg:write key="schedule.108" /><br><gsmsg:write key="cmn.user" /><gsmsg:write key="cmn.change" /></b>
</logic:equal>
<logic:empty name="mbhSch050Form" property="sch050DispMod">
<b><%= emojiTokei.toString() %><gsmsg:write key="schedule.108" /><br><gsmsg:write key="schedule.117" /></b>
</logic:empty>
<hr>
...
<html:select name="mbhSch050Form" property="sch040GroupSid">
...
<input name="<%= jp.groupsession.v3.mbh.sch040.MbhSch040Form.PARAM_SELECTADR %><bean:write name="userList" property="usrSid" />" value="<gsmsg:write key="cmn.select" />" type="submit"><bean:write name="userList" property="usiSei" /> <bean:write name="userList" property="usiMei" /><br>
</logic:iterate>
</logic:notEmpty>
<div align="center">
<br>
...
<html:select name="mbhSch050Form" property="sch050GroupSid" styleClass="select01">
...
<a href="./<bean:write name="mbhSch050Form" property="sch050DispId" />.do<%= jsessionId.toString() %>?CMD=addUser&sch010SelectUsrSid=<bean:write name="userList" property="value" />&sch010DspDate=<bean:write name="mbhSch050Form" property="sch010DspDate" />&sch010DspGpSid=<bean:write name="mbhSch050Form" property="sch050GroupSid" />&changeDateFlg=<bean:write name="mbhSch050Form" property="changeDateFlg" />"><bean:write name="userList" property="label" /></a><br>
</logic:iterate>
</logic:notEmpty>
</logic:equal>
<input name="sch050back" value="<gsmsg:write key="cmn.back" />" type="submit">
</div>
</html:form>
