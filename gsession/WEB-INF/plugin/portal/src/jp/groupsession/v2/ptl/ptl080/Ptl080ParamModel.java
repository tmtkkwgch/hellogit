...
import jp.groupsession.v2.ptl.ptl040.Ptl040ParamModel;
import jp.groupsession.v2.ptl.ptl080.model.Ptl080Model;

import org.apache.struts.util.LabelValueBean;

/**
 * <br>[機  能] ポータル プラグイン選択画面(ポップアップ)のパラメータ情報を保持するModelクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Ptl080ParamModel extends Ptl040ParamModel {
    /** メイン表示一覧 */
