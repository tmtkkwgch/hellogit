...
import jp.groupsession.v2.ptl.ptl080.Ptl080ParamModel;

import org.apache.struts.util.LabelValueBean;

/**
 * <br>[機  能] ポータル ポートレット選択画面(ポップアップ)のパラメータ情報を保持するModelクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Ptl081ParamModel extends Ptl080ParamModel {
    /** 選択カテゴリID */
