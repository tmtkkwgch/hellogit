...
<%-- CMD定数 --%>
<%
    String backClick          = jp.groupsession.v2.prj.prj024.Prj024Action.CMD_BACK_CLICK;
    String editClick          = jp.groupsession.v2.prj.prj024.Prj024Action.CMD_EDIT_CLICK;
%>
...
<html:form action="/project/prj024">
...
<logic:notEmpty name="prj024Form" property="prj040scMemberSid" scope="request">
  <logic:iterate id="item" name="prj024Form" property="prj040scMemberSid" scope="request">
    <input type="hidden" name="prj040scMemberSid" value="<bean:write name="item"/>">
  </logic:iterate>
</logic:notEmpty>

<logic:notEmpty name="prj024Form" property="prj040svScMemberSid" scope="request">
  <logic:iterate id="item" name="prj024Form" property="prj040svScMemberSid" scope="request">
...
<logic:notEmpty name="prj024Form" property="prj030sendMember" scope="request">
  <logic:iterate id="item" name="prj024Form" property="prj030sendMember" scope="request">
...
<logic:notEmpty name="prj024Form" property="prj020syozokuMember" scope="request">
  <logic:iterate id="item" name="prj024Form" property="prj020syozokuMember" scope="request">
    <input type="hidden" name="prj020syozokuMember" value="<bean:write name="item"/>">
  </logic:iterate>
</logic:notEmpty>

<logic:notEmpty name="prj024Form" property="prj020user" scope="request">
  <logic:iterate id="item" name="prj024Form" property="prj020user" scope="request">
    <input type="hidden" name="prj020user" value="<bean:write name="item"/>">
  </logic:iterate>
</logic:notEmpty>

<logic:notEmpty name="prj024Form" property="prj020hdnMember" scope="request">
  <logic:iterate id="item" name="prj024Form" property="prj020hdnMember" scope="request">
    <input type="hidden" name="prj020hdnMember" value="<bean:write name="item"/>">
  </logic:iterate>
</logic:notEmpty>

<logic:notEmpty name="prj024Form" property="prj020adminMember" scope="request">
  <logic:iterate id="item" name="prj024Form" property="prj020adminMember" scope="request">
    <input type="hidden" name="prj020adminMember" value="<bean:write name="item"/>">
  </logic:iterate>
</logic:notEmpty>

<logic:notEmpty name="prj024Form" property="prj020prjMember" scope="request">
  <logic:iterate id="item" name="prj024Form" property="prj020prjMember" scope="request">
    <input type="hidden" name="prj020prjMember" value="<bean:write name="item"/>">
  </logic:iterate>
</logic:notEmpty>

<logic:notEmpty name="prj024Form" property="prj020hdnAdmin" scope="request">
  <logic:iterate id="item" name="prj024Form" property="prj020hdnAdmin" scope="request">
    <input type="hidden" name="prj020hdnAdmin" value="<bean:write name="item"/>">
  </logic:iterate>
</logic:notEmpty>

<html:hidden property="prj022cateAdd" />
<html:hidden property="prj022cateSlc" />
  ...
  <td align="center">
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
      <tr>
        ...
        <td width="0%" class="header_white_bg_text">[ <gsmsg:write key="project.prj024.1" /> ]</td>
    ...
    <td align="left" class="td_wt">
      ...
      <tr>
      <td>
        <bean:define id="lblname" name="prj024Form" property="cateName" type="java.lang.String" />
        <span class="text_r1"><gsmsg:write key="project.25" arg0="<%= lblname %>" /><br>
        <gsmsg:write key="project.26" /></span><br>
        <html:select property="prj024cateSlc" size="5" styleClass="select01">
           <html:optionsCollection name="prj024Form" property="statusLabel" value="value" label="label" />
        </html:select>
      </td>
      </tr>
      </table>
