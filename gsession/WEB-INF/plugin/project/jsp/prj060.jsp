...
<td width="100%" align="center">
  ...
  <td width="65%" valign="top">
    ...
    <span class="text_base_prj"><bean:write name="prj060Form" property="addUserName" /></span>
    </logic:equal>
    <logic:notEqual name="prj060Form" property="addUserStatus" value="<%= jkbnToroku %>">
    <del><span class="text_base_prj"><bean:write name="prj060Form" property="addUserName" /></span></del>
    </logic:notEqual>
    </td>
    </tr>
    ...
    <td class="td_sub_detail" colspan="3">
      ...
      <logic:iterate id="memMdl" name="prj060Form" property="userList" scope="request">
    ...
    <tr valign="center">
    <td>
      <span class="text_base">URL:&nbsp;</span><input type="text" value="<bean:write name="prj060Form" property="prj060TodoUrl" />" style="width:633px;" class="text_todoUrl" readOnly="true" />
    </td>
    </tr>
    </table>
    ...
    <td>
      ...
      <logic:iterate id="comMdl" name="prj060Form" property="todoComList" scope="request">
    ...
    <td align="center">
      <table class="prj_todo_comadd_bk" width="100%" cellpadding="5">
        ...
        <td width="100%">
          ...
          <textarea name="prj060comment" style="width:405px;" rows="5" class="text_gray textarea_base" onkeyup="showLengthStr(value, <%= maxLengthToDoCmt %>, 'inputlength');" id="inputstr"><bean:write name="prj060Form" property="prj060comment" /></textarea>
          <br>
  ...
  <td width="35%" align="center" valign="top">
      ...
      <td class="td_type1">
        ...
        <logic:equal name="prj060Form" property="todoEdit" value="true">
          ...
          <html:select property="prj060SelectYearFr" styleId="prj060SelectYearFr">
            <html:optionsCollection name="prj060Form" property="yearLabel" value="value" label="label" />
          </html:select>

          <html:select property="prj060SelectMonthFr" styleId="prj060SelectMonthFr">
            <html:optionsCollection name="prj060Form" property="monthLabel" value="value" label="label" />
          </html:select>

          <html:select property="prj060SelectDayFr" styleId="prj060SelectDayFr">
            <html:optionsCollection name="prj060Form" property="dayLabel" value="value" label="label" />
          </html:select>
        ...
        <tr>
        <td><textarea name="prj060riyu" style="width:252px;" rows="3" class="text_gray textarea_base" onkeyup="showLengthStr(value, <%= maxLengthReason %>, 'inputlength2');" id="inputstr2"><bean:write name="prj060Form" property="prj060riyu" /></textarea>
        <br>
        ...
        <tr>
        <td align="center"><input type="button" value="<gsmsg:write key="cmn.update" />" class="btn_edit_n1" onclick="buttonPush('<%= updateClick %>');"></td>
        </tr>
        </table>
        </logic:equal>
    ...
    <td>
      ...
      <td class="td_sub_detail">
        ...
        <logic:iterate id="prjHis" name="prj060Form" property="todoHisList">
        <tr>
