...
<title>[Group Session] <gsmsg:write key="project.107" /> <gsmsg:write key="project.prj200kn.1" /></title>
...
<html:form action="/project/prj200kn">
...
<html:hidden property="prj200Date" />
<html:hidden property="prj200Status" />
<html:hidden property="prj200Member" />
...
<td width="100%" align="center">
  ...
  <td>
    ...
    <td width="100%" class="header_ktool_bg_text2">[ <gsmsg:write key="project.prj200kn.1" /> ]</td>
    ...
    <td class="header_glay_bg" width="50%">
      ...
      <input type="button" value="<gsmsg:write key="cmn.back" />" class="btn_back_n1" onClick="return buttonPush('backPrj200');">
    </td>
    ...
    <td align="left" class="td_wt" width="100%">
      <span class="text_base"><bean:write name="prj200knForm" property="prj200knDateStr" /></span>
    </td>
    </tr>
    <tr>
    <td class="table_bg_A5B4E1" width="0%" nowrap><span class="text_bb1"><gsmsg:write key="cmn.status" /></span></td>
    <td align="left" class="td_wt" width="100%">
      <span class="text_base"><bean:write name="prj200knForm" property="prj200knStatusStr" /></span>
    </td>
    </tr>
    <tr>
    <td class="table_bg_A5B4E1" width="0%" nowrap><span class="text_bb1"><gsmsg:write key="cmn.member" /></span></td>
    <td align="left" class="td_wt" width="100%">
      <span class="text_base"><bean:write name="prj200knForm" property="prj200knMemberStr" /></span>
    </td>
    </tr>
    </table>
