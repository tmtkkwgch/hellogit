...
<html:form action="/project/prj220">
...
<td width="100%" align="center">
  ...
  <td>
    ...
    <td width="100%" class="header_ktool_bg_text2">[ <gsmsg:write key="schedule.108" /><gsmsg:write key="cmn.display.settings" /> ]</td>
    ...
    <td class="td_type1">
      <html:radio name="prj220Form" styleId="prj220Dsp_01" property="prj220SchDsp" value="<%= String.valueOf(jp.groupsession.v2.prj.GSConstProject.DSP_TODO_SHOW) %>" /><label for="prj220Dsp_01"><span class="text_bb1"><gsmsg:write key="cmn.display.ok" /></span></span></label>&nbsp;
      <html:radio name="prj220Form" styleId="prj220Dsp_02" property="prj220SchDsp" value="<%= String.valueOf(jp.groupsession.v2.prj.GSConstProject.DSP_TODO_NOT_SHOW) %>" /><label for="prj220Dsp_02"><span class="text_bb1"><gsmsg:write key="cmn.dont.show" /></span></label>&nbsp;
    </td>
