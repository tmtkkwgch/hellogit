...
<td width="100%" align="center">
  ...
  <td align="center">
    ...
    <td width="0%" class="header_white_bg_text">[ <gsmsg:write key="project.prj023.1" /> ]</td>
    ...
    <tr>
    <td class="table_bg_A5B4E1" rowspan="3" nowrap><span class="text_bb1"><gsmsg:write key="project.src.46" /></span><span class="text_r2">※</span></td>
    <td align="left" class="td_wt"><span class="text_bb1">0%&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;<html:text property="prj023name0" style="width:177px;" maxlength="20" /></span></td>
    </tr>
    ...
    <td align="left" class="td_wt">
      ...
      <tr>
      <td>
        <span class="text_bb1"><gsmsg:write key="project.src.34" /></span> <html:text property="prj023rate" style="width:45px;" maxlength="2" />%
        &nbsp;&nbsp;<span class="text_bb1"><gsmsg:write key="project.src.42" /></span> <html:text property="prj023name" style="width:177px;" maxlength="20" />
      </td>
      <td>
      ...
      <tr>
      <td>
        <html:select property="prj023state" size="5" styleClass="select01" style="width: 350px!important">
    ...
    <tr>
    <td align="left" class="td_wt"><span class="text_bb1">100%&nbsp;:&nbsp;<html:text property="prj023name100" style="width:177px;" maxlength="20" /></span></td>
    </tr>
    </table>
