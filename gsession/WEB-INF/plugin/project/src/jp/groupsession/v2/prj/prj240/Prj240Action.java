...
/**
 * <br>[機  能] プロジェクト管理 個人設定 TODO登録画面初期値設定画面のアクションクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Prj240Action extends AbstractProjectAction {
    ...
    private ActionForward __doEdit(ActionMapping map,
        ...
        try {
            ...
            Prj240Biz biz = new Prj240Biz(con);
            Prj240ParamModel paramMdl = new Prj240ParamModel();
    ...
    private ActionForward __doCompDsp(ActionMapping map,
        ...
        //TODO表示設定
        String textPrjSch = gsMsg.getMessage(req, "main.6")
                          + gsMsg.getMessage(req, "cmn.display")
                          + gsMsg.getMessage(req, "ntp.10");
