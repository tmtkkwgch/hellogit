...
/**
 * <br>[機  能] IP管理 ネットワーク登録画面のフォーム
 * <br>[解  説]
 * <br>[備  考]
 * @author JTS
 */
public class Ipk020Form extends Ipk010Form {
     ...
     * <br>[備  考]
     *
     * @param validateCheckModel 入力チェックモデル
     * @param con コネクション
     * @param reqMdl リクエスト情報
     * @return エラー
     * @throws SQLException SQL実行時例外
     */
    public ActionErrors validateCheck(ValidateCheckModel validateCheckModel,
                                       Connection con,
        ...
        String textSort = gsMsg.getMessage("cmn.sort");
        ...
        //-- サブネットマスク全体 --
        if (errors.isEmpty()) {
            if (netSabnet1__ != null && netSabnet2__ != null
                && netSabnet3__ != null && netSabnet4__ != null) {
                errors = IpkValidate.validateSubnetFieldText(
                                                errors,
                                                textSabnet,
                                                netSabnet1__ + "." + netSabnet2__
                                                + "." + netSabnet3__ + "." + netSabnet4__,
                                                "netSabnet");
            }
        }
