...
import jp.groupsession.v2.ip.ipk060.Ipk060Form;
...
/**
 * <br>[機  能] IP管理 詳細検索画面のフォーム
 * <br>[解  説]
 * <br>[備  考]
 * @author JTS
 */
public class Ipk070Form extends Ipk060Form {
    ...
    public ActionErrors ipk070ValidateCheck(RequestModel reqMdl) {
        ...
        if (!StringUtil.isNullZeroStringSpace(ipk070KeyWord__)) {
            errors = IpkValidate.validateSearchFieldText(
                                                errors,
                                                textKeyword,
                                                ipk070KeyWord__,
                                                "ipk070KeyWord",
