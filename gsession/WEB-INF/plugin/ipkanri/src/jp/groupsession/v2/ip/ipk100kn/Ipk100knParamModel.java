...
import jp.groupsession.v2.ip.ipk100.Ipk100ParamModel;

/**
 * <br>[機  能] IP管理 スペックマスタメンテナンス 登録確認画面の情報を保持するModelクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Ipk100knParamModel extends Ipk100ParamModel {
    /** 名前 */
