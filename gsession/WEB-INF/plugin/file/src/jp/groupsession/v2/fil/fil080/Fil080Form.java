 ...
 * @author JTS
 */
public class Fil080Form extends Fil070Form {
    ...
    /** 複数登録区分 */
    private String fil080PluralKbn__ = "0";
    /** 複数登録区分保持用 */
    ...
    public boolean checkSltMoveDirAccess(Connection con, RequestModel reqMdl)
        ...
        int fcbSid = cmnBiz.getCabinetSid(NullDefault.getInt(getFil070ParentDirSid(), -1), con);
