 ...
 * @author JTS
 */
public class Fil020Form extends Fil010Form {
     ...
     */
    public ActionErrors fil020RepairCheck(Connection con, RequestModel reqMdl)
        ...
        if (!biz.isDirAccessAuthUser(NullDefault.getInt(getFil010SelectCabinet(), -1),
                                     NullDefault.getInt(fil020SltDirSid__, -1),
