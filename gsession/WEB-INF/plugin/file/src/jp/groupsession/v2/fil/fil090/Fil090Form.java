...
import jp.groupsession.v2.fil.fil080kn.Fil080knForm;
 ...
 * @author JTS
 */
public class Fil090Form extends Fil080knForm {
    ...
    throws SQLException {
        ...
        if (ecode == FilCommonBiz.ERR_NOT_EXIST) {
            msg = new ActionMessage("error.not.exitst.myself.dir", targetName);
            StrutsUtil.addMessage(errors, msg, "selectDir");
            return errors;
        }
