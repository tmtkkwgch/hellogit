...
<logic:notEmpty name="fil130Form" property="fil040SelectDel" scope="request">
  <logic:iterate id="del" name="fil130Form" property="fil040SelectDel" scope="request">
    <input type="hidden" name="fil040SelectDel" value="<bean:write name="del"/>">
  </logic:iterate>
</logic:notEmpty>

<logic:notEmpty name="fil130Form" property="fil010SelectDelLink" scope="request">
  <logic:iterate id="del" name="fil130Form" property="fil010SelectDelLink" scope="request">
...
<td width="100%" align="center">
  ...
  <td align="center">
    ...
    <td class="header_glay_bg" width="50%">
      <input type="button" name="btn_add" class="btn_ok1" value="OK" onClick="buttonPush('fil130ok');">
      <input type="button" class="btn_back_n1" value="<gsmsg:write key="cmn.back" />" onclick="buttonPush('fil130back');">
    ...
    <td width="80%" valign="middle" align="left" class="td_wt text_base7">
      <span style="font-size: 80%;"><gsmsg:write key="fil.fil130.1" /></span><br>
      <html:radio name="fil130Form" styleId="smailSend_01" property="fil130SmailSend" value="<%= smailSendOff %>" /><label for="smailSend_01"><span class="text_base7"><gsmsg:write key="cmn.dont.notify" /></span></label>&nbsp;
      <html:radio name="fil130Form" styleId="smailSend_02" property="fil130SmailSend" value="<%= smailSendOn %>" /><label for="smailSend_02"><span class="text_base7"><gsmsg:write key="cmn.notify" /></span></label>
    </td>
    </tr>
