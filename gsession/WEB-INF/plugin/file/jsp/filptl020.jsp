...
<script language="JavaScript" src="../file/js/filptl020.js?<%= GSConst.VERSION_PARAM %>"></script>

<title>[Group Session] <gsmsg:write key="fil.ptl020.1" /></title>
</head>
...
<td width="100%" align="center">
  ...
  <td>
    ...
    <tr>
    <td width="0%"><img src="../file/images/header_project_01.gif" border="0" alt=""></td>
    ...
    <td width="100%" class="header_white_bg_text">[ <gsmsg:write key="fil.ptl020.1" /> ]</td>
  ...
  <span class="text_base"><gsmsg:write key="fil.ptl020.2" /></span>
  </td>
  </tr>
  ...
  <td>
    ...
    <table class="tl0" cellpadding="5" cellspacing="0" border="0" width="100%">
    <tr>
    <th align="center" class="td_type24" width="0%" nowrap><span class="text_bb1"><gsmsg:write key="fil.23" /></span></th>
    </tr>
    ...
    <td align="left" class="<%= tdColor %>" width="100%" nowrap>
      <img src="../file/images/menu_icon_single.gif" class="img_bottom" alt="">
      <a href="javascript:void(0);" onClick="return selectCabinet('<bean:write name="cabinetModel" property="fcbSid" />');"><span class="text_link"><bean:write name="cabinetModel" property="fcbName" /></span></a>
    </td>
    </tr>
