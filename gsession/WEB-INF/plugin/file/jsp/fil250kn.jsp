...
<td width="100%" align="center">
  ...
  <td align="center">
    ...
    <td width="100%" class="header_ktool_bg_text2">[ <gsmsg:write key="cmn.filekanri" />　<gsmsg:write key="fil.fil250kn.1" /> ]</td>
    ...
    <td class="header_glay_bg" width="50%">
      <input type="button" class="btn_ok1" value="OK" onclick="buttonPush('fil250knok');">
      <input type="button" class="btn_back_n1" value="<gsmsg:write key="cmn.back" />" onclick="buttonPush('fil250knback');">
    </td>
    ...
    <tr>
    <td align="left">
      <span class="text_r1">※<gsmsg:write key="fil.fil250kn.2" /></span>
    </td>
    <tr><td>&nbsp;</td></tr>
    <tr>
    </table>
    ...
    <tr>
    <td class="td_sub_title" width="20%" nowrap><span class="text_bb1"><gsmsg:write key="cmn.folder" /></span></td>
    <td class="td_sub_detail" align="left" width="80%"><span class="text_base_prj"><div id="moveDirName"><bean:write name="fil250knForm" property="fil250DirPath" /></div></span></td>
    </tr>

    <tr>
    <td class="td_sub_title" nowrap>
    <span class="text_bb1"><gsmsg:write key="fil.125" /></span>
    </td>
    <td align="left" class="td_sub_detail">
      <logic:notEmpty name="fil250knForm" property="fil250callUserCombo">
      <logic:iterate id="callUser" name="fil250knForm" property="fil250callUserCombo">
        <span class="text_base"><bean:write name="callUser" property="label" /></span><br>
      </logic:iterate>
      </logic:notEmpty>
    </td>
    </tr>
