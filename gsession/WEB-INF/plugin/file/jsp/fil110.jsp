...
<td width="100%" align="center" cellpadding="5" cellspacing="0">
  ...
  <td align="left">
    ...
    <table cellpadding="5" cellspacing="0" border="0" width="100%">
      <tr>
        <td align="right">
          <input type="button" value="<gsmsg:write key="cmn.back" />" class="btn_back_n1" onClick="buttonPush('fil110back');">
        </td>
      </tr>
    </table>
    ...
    <table cellpadding="5" cellspacing="0" border="0" width="100%">
      <tr>
        <td align="left">
          ...
          <dt><a href="#" onClick="buttonPush('fil110dspConf');"><span class="text_link"><gsmsg:write key="cmn.display.settings" /></span></a></dt>
          <dd><div class="text"><li><gsmsg:write key="fil.fil110.1" /></li></div></dd>
          </dl>
        </td>
      </tr>

      <logic:equal name="fil110Form" property="fil110smailUseKbn" value="<%= smailUseKbn %>">
      <logic:equal name="fil110Form" property="fil110SmailSendKbn" value="<%= String.valueOf(jp.groupsession.v2.fil.GSConstFile.FAC_SMAIL_SEND_KBN_USER) %>">
      <tr>
        <td align="left">
          <dl class="decorate_textbox1">
          <dt><a href="#" onClick="buttonPush('fil110smailConf');"><span class="text_link"><gsmsg:write key="cmn.sml.notification.setting" /></span></a></dt>
          <dd><div class="text"><li><gsmsg:write key="fil.fil110.2" /></li></div></dd>
          </dl>
        </td>
      </tr>
      </logic:equal>
