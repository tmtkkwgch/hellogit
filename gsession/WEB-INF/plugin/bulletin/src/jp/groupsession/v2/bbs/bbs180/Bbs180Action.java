 ...
 * <br>[備  考]
 */
public class Bbs180Action extends AbstractBulletinAction {

    /** Logging インスタンス */
    private static Log log__ = LogFactory.getLog(Bbs180Action.class);
     ...
     */
     public ActionForward executeAction(ActionMapping map,
         ...
         Bbs180Form thisForm = (Bbs180Form) form;
    ...
    /**
      ...
      * @return アクションフォーム
      */
     private ActionForward __movePage(ActionMapping map, Bbs180Form form,
                     HttpServletRequest req, HttpServletResponse res, Connection con, int pageNo)
             throws SQLException {

         //ページ数調整
         int page = form.getBbs180NowPage();
         page += pageNo;
         if (page < 1) {
             page = 1;
         }
         form.setBbs180NowPage(page);
     ...
     private ActionForward __doInit(ActionMapping map,
         ...
         Bbs180Biz biz = new Bbs180Biz(con, getRequestModel(req));

         Bbs180ParamModel paramMdl = new Bbs180ParamModel();
     ...
     * @return ActionForward
     */
    private ActionForward __backToMenu(ActionMapping map, Bbs180Form form) {
        ActionForward forward = null;
