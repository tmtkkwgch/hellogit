...
<td width="100%" align="center">
  ...
  <td>
    ...
    <table class="tl0" cellpadding="5" cellspacing="0" border="0" width="100%">
    <tr>
    <th align="center" class="td_type24" width="0%" nowrap><span class="text_bb1"><gsmsg:write key="bbs.3" /></span></th>
    </tr>
    ...
    <td align="left" class="<%= tdColor %>" width="100%" nowrap>
              ...
              <logic:equal name="forInfModel" property="binSid" value="0">
                <img class="img_bottom" src="../bulletin/images/cate_icon01.gif" alt="<gsmsg:write key="bbs.3" />">
              </logic:equal>

              <!-- フォーラム画像original -->
              <logic:notEqual name="forInfModel" property="binSid" value="0">
                <img class="img_bottom" width="30px" height="30px" src="../bulletin/bbsptl020.do?CMD=getImageFile&bbsptl020binSid=<bean:write name="forInfModel" property="binSid" />&bbsptl020forumSid=<bean:write name="forInfModel" property="bfiSid" />" alt="<gsmsg:write key="bbs.3" />">
              </logic:notEqual>
      <a href="javascript:void(0);" onClick="return selectForum('<bean:write name="forInfModel" property="bfiSid" />');"><span class="text_link"><bean:write name="forInfModel" property="bfiName" /></span></a>
    </td>
    </tr>
