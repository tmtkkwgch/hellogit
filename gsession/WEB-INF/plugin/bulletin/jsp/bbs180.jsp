...
<title>[Group Session] <gsmsg:write key="cmn.bulletin" /></title>
...
<script language="JavaScript" src='../bulletin/js/bbs180.js?<%= GSConst.VERSION_PARAM %>'></script>
...
<html:hidden property="bbs180DateWeeklyFrStr" />
<html:hidden property="bbs180DateWeeklyToStr" />
<html:hidden property="bbs180DateDailyFrStr" />
<html:hidden property="bbs180DateDailyToStr" />
                    ...
                    <tr>
                      ...
                      <td valign="middle" style="padding:0px;margin:0px;">
                        <p id="jquery-ui-datepicker-wrap"><span style="font-size:12px;font-weight:bold;padding-left:12px;" class="text_base"><gsmsg:write key="ntp.132" /><gsmsg:write key="wml.215" /></span>
                          <input readonly="readonly" style="cursor:pointer; width:125px;" value="<bean:write name="bbs180Form" property="bbs180DateWeeklyFrStr" />" type="text" id="jquery-ui-datepicker-from" name="jquery-ui-datepicker-from"/>
                          <label for="jquery-ui-datepicker-from"><span class="text_base"><gsmsg:write key="tcd.153" /></span></label>
                          <input readonly="readonly" style="cursor:pointer; width:125px;" value="<bean:write name="bbs180Form" property="bbs180DateWeeklyToStr" />" type="text" id="jquery-ui-datepicker-to" name="jquery-ui-datepicker-to"/>
                        </p>
                      </td>
                      </logic:equal>
                      ...
                      <td valign="middle" style="padding:0px;margin:0px;">
                        <p id="jquery-ui-datepicker-wrap"><span style="font-size:12px;font-weight:bold;padding-left:12px;" class="text_base"><gsmsg:write key="ntp.132" /><gsmsg:write key="wml.215" /></span>
                          <input readonly="readonly" style="cursor:pointer; width:125px;" value="<bean:write name="bbs180Form" property="bbs180DateDailyFrStr" />" type="text" id="jquery-ui-datepicker-from" name="jquery-ui-datepicker-from"/>
                          <label for="jquery-ui-datepicker-from"><span class="text_base"><gsmsg:write key="tcd.153" /></span></label>
                          <input readonly="readonly" style="cursor:pointer; width:125px;" value="<bean:write name="bbs180Form" property="bbs180DateDailyToStr" />" type="text" id="jquery-ui-datepicker-to" name="jquery-ui-datepicker-to"/>
                        </p>
                      </td>
                      </logic:equal>
                      ...
                      <div class="category_sel_area">
                        ...
                        <html:select style="width:50px;" name="bbs180Form" property="bbs180DspNum" styleClass="select01" onchange="changeDspNumCombo();">
                      ...
                      <div class="category_sel_area">
                        <span style="font-size:12px;font-weight:bold;" class="text_base"><gsmsg:write key="bbs.bbs180.1" />
                        <bean:write name="bbs180Form" property="bbsUpCnt" /></span>
                      </div>
                      <div class="category_sel_area">
                        <span style="font-size:12px;font-weight:bold;" class="text_base"><gsmsg:write key="bbs.bbs180.2" />
                        <bean:write name="bbs180Form" property="bbsThreCnt" /></span>
                      </div>
                      </td>
                      ...
                      <div class="category_sel_area">
                        <html:radio name="bbs180Form" property="bbs180DateUnit" value="2" styleId="radio_month" onclick="buttonPush('dateUnitChange');"/>
                        <label for="radio_month" style="font-size:12px;font-weight:bold;" class="text_base"><gsmsg:write key="cmn.monthly.3" /></label>
                        <html:radio name="bbs180Form" property="bbs180DateUnit" value="1" styleId="radio_week" onclick="buttonPush('dateUnitChange');"/>
                        <label for="radio_week" style="font-size:12px;font-weight:bold;" class="text_base"><gsmsg:write key="cmn.weekly3" /></label>
                        <html:radio name="bbs180Form" property="bbs180DateUnit" value="0" styleId="radio_day" onclick="buttonPush('dateUnitChange');"/>
              ...
              <tr>
                <td style="padding:0px;margin:0px;" width="100%">
                  <table  width="100%" style="padding:0px;margin:0px;">
                    <tr height="290px">
                      <%-- メニュー--%>
                      <td width="180px" valign="top" id="sel_menu_wrapper" style="border-top:1px solid #c5c5c5;border-left:1px solid #c5c5c5;border-bottom:1px solid #c5c5c5;">
                        <div style="margin:0px;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px;">
                          <table width="180px" style="margin-top:0px;margin-right:0px;margin-bottom:3px;margin-left:0px;">
                            <tr>
                              <td class="sel_menu_area" id="bbs_graph_view" onclick="changeDspItem('bbs_graph_view');">
                                <div class="sel_menu_title"><span><gsmsg:write key="bbs.11" /></span></div>
                              </td>
                            </tr>
                            <tr>
                              <td class="sel_menu_area" id="bbs_graph_write" onclick="changeDspItem('bbs_graph_write');">
                                <div class="sel_menu_title"><span><gsmsg:write key="bbs.5" /></span></div>
                               </td>
                            </tr>
                          </table>
                        </div>
                      ...
                      <td valign="top" style="width:100%;padding:0px;margin:0px;">
                        <table style="padding:0px;margin:0px;" width="99%">
                          ...
                          <div id="bbsCntGraph" style="height:260px;"></div>
                          </td>
                          </tr>
                          ...
                          <logic:greaterThan name="pageCount" value="1">
                            ...
                            <html:select property="bbs180DspPage1" onchange="changePage(this);" styleClass="text_i">
                                  ...
                                  <td valign="top">
                                    <table width="100%" class="anken_val_table" id="anken_val_table">
                                      ...
                                      <tr class="anken_val_title" id="anken_val_title">
                                        ...
                                        <td width="30%"><b><gsmsg:write key="bbs.11" /></b></td>
                                        <td width="30%"><b><gsmsg:write key="bbs.5" /></b></td>
                                      </tr>
                                      ...
                                      <td align="right"><bean:write name="dayData" property="strVbbsNum" /></td>
                                      <td align="right"><bean:write name="dayData" property="strWbbsNum" /></td>
                                      </tr>
                                      </logic:iterate>

                                      <tr class="anken_val">
                                      <td align="center"><b><gsmsg:write key="cmn.average" /></b></td>
                                      <td align="right"><b><bean:write name="bbs180Form" property="bbs180AveVbbsNum" /></b></td>
                                      <td align="right"><b><bean:write name="bbs180Form" property="bbs180AveWbbsNum" /></b></td>
                                      </tr>
                                      <tr class="anken_val">
                                      <td align="center"><b><gsmsg:write key="cmn.sum" /></b></td>
                                      <td align="right"><b><bean:write name="bbs180Form" property="bbs180SumVbbsNum" /></b></td>
                                      <td align="right"><b><bean:write name="bbs180Form" property="bbs180SumWbbsNum" /></b></td>
                                      </tr>
                                      </logic:notEmpty>
                          ...
                          <bean:size id="pageCount2" name="bbs180Form" property="bbs180PageLabel" scope="request" />
                          <logic:greaterThan name="pageCount2" value="1">
                            <img alt="<gsmsg:write key="cmn.previous.page" />" height="20" src="../common/images/arrow2_l.gif" class="text_i" width="20" border="0" onClick="buttonPush('pageLast');">
                            <logic:notEmpty name="bbs180Form" property="bbs180PageLabel" scope="request">
                            <html:select property="bbs180DspPage2" onchange="changePage(this);" styleClass="text_i">
                            <html:optionsCollection name="bbs180Form" property="bbs180PageLabel" value="value" label="label" />
                            </html:select>
                            </logic:notEmpty>
                            <img src="../common/images/arrow2_r.gif" name ="btn_next" alt="<gsmsg:write key="cmn.next.page" />" class="text_i" width="20" height="20" border="0" onClick="buttonPush('pageNext');">
