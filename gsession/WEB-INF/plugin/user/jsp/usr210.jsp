...
<body class="body_03" onload="freezeScreenParent('', false);parentReadOnly();init(<bean:write name="usr210Form" property="usr210initFlg" />);">
...
<tr>
  ...
  <tr>
    ...
    <td align="left" class="td_wt" width="80%">
      <html:select name="usr210Form" property="categorySid" styleClass="text_i" onchange="changeCategory('changeCategory');" >
...
<br>
  ...
  <td width="0%">
  <html:multibox name="usr210Form" property="usr210selectLabel" styleId="<%= labelNo + Integer.toString(count) %>">
