...
<td width="100%" align="center">
  ...
  <td align="left">
    ...
    <table cellpadding="5" cellspacing="0" border="0" width="100%">
      <tr>
        <td align="right">
          <input type="button" value="<gsmsg:write key="cmn.back" />" class="btn_back_n1" onClick="buttonPush('usr042back')">
        </td>
      </tr>
    </table>
    ...
    <table cellpadding="5" cellspacing="0" border="0" width="100%">
      <tr>
        <td align="left">
          ...
          <dt><a href="#" onClick="buttonPush('dspConf')"><span class="text_link"><gsmsg:write key="cmn.display.settings" /></span></a></dt>
          <dd><div class="text"><li><gsmsg:write key="user.usr042.3" /></li></div></dd>
          </dl>
