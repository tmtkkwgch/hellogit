...
<body class="body_03">
<html:form action="/user/usr045kn">
...
<logic:notEmpty name="usr045knForm" property="usr040labSid">
  <logic:iterate id="labSidArray" name="usr045knForm" property="usr040labSid" indexId="idx">
...
<logic:notEmpty name="usr045knForm" property="usr040labSidSave">
  <logic:iterate id="labSidArraySave" name="usr045knForm" property="usr040labSidSave" indexId="idx">
...
<html:hidden property="usr045CategoryName" />
<html:hidden property="usr045bikou" />
<html:hidden property="usr043EditSid" />

<html:hidden property="usr040CategorySetInitFlg" />

<logic:notEmpty name="usr045knForm" property="usr040CategoryOpenFlg">
<logic:iterate id="openFlg" name="usr045knForm" property="usr040CategoryOpenFlg">
...
<td width="100%" align="center">
  ...
  <td>
    ...
    <td align="left" class="td_type1" width="80%"><bean:write name="usr045knForm" property="usr045CategoryName" />
    </td>
    </tr>

    <tr>
    <td class="table_bg_A5B4E1" nowrap><span class="text_bb1"><gsmsg:write key="cmn.memo" /></span></td>
    <td align="left" class="td_type1"><bean:write name="usr045knForm" property="bikou" filter="false"  />
    </td>
    </tr>
    </table>
