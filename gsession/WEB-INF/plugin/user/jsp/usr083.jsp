...
<td width="100%" align="center">
  ...
  <td>
    ...
    <input type="button" class="btn_ok1" value="OK" onClick="return buttonPush('usr083kakunin');">
    <input type="button" class="btn_back_n3" value="<gsmsg:write key="cmn.back.admin.setting" />" onClick="return buttonPush('usr083back');">
  ...
  <td>
    ...
    <td align="left" class="td_type20">
      ...
      <html:radio name="usr083Form" styleId="usr083Pow1_01" property="usr083Pow1" value="1" /><label for="usr083Pow1_01"><span class="text_base_user1 "><gsmsg:write key="cmn.only.admin.editable" /></span></label>&nbsp;
      <html:radio name="usr083Form" styleId="usr083Pow1_02" property="usr083Pow1" value="0" /><label for="usr083Pow1_02"><span class="text_base_user1 "><gsmsg:write key="cmn.noset.edit.permissions.label" /></span></label>
    ...
    <tr>
    <td class="table_bg_A5B4E1" nowrap><span class="text_bb1"><gsmsg:write key="user.11" /></span></td>
    <td align="left" class="td_type20">

      <table width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr>
      <td align="left" width="100%">
      <html:radio name="usr083Form" styleId="usr083Pow2_01" property="usr083Pow2" value="1" /><label for="usr083Pow2_01"><span class="text_base_user1 "><gsmsg:write key="user.12" /></span></label>&nbsp;
      <html:radio name="usr083Form" styleId="usr083Pow2_02" property="usr083Pow2" value="0" /><label for="usr083Pow2_02"><span class="text_base_user1 "><gsmsg:write key="user.13" /></span></label>
      <div class="text_base7"><gsmsg:write key="user.usr083.2" /></div>
      </td>
      </tr>
      </table>
