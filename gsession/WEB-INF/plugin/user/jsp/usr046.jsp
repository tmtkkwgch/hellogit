...
<td width="100%" align="center">
  ...
  <td>
    ...
    <input type="button" value="OK" class="btn_ok1" onClick="buttonPush('usr046ok');">
  <logic:equal name="usr046Form" property="usr044ProcMode" value="<%= kbnFlg %>">
    ...
    <input type="button" value="<gsmsg:write key="cmn.back" />" class="btn_back_n1" onClick="buttonPush('labelListback');">
    </td>
  ...
  <td>
    ...
    <tr>
    <td class="table_bg_A5B4E1" width="20%" nowrap><span class="text_bb1"><gsmsg:write key="wml.74" /></span><span class="text_r2">※</span></td>
    <td align="left" class="td_wt" width="80%">
    <html:text style="width:275px;" maxlength="30" property="usr046LabelName" styleClass="text_base" />
    </td>
    </tr>
    ...
    <textarea name="usr046bikou" style="width:566px" rows="5" styleClass="text_gray" onkeyup="showLengthStr(value, <%= maxLengthBiko %>, 'inputlength');" id="inputstr"><bean:write name="usr046Form" property="usr046bikou" /></textarea>
    <br>
