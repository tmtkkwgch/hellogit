...
<body class="body_03">
<html:form action="/nippou/ntp093">
...
<td width="100%" align="center">
  ...
  <td align="left">
    ...
    <td width="100%" class="header_ktool_bg_text">[ <gsmsg:write key="ntp.1" /> <gsmsg:write key="schedule.74" />表示設定 ]</td>
    ...
    <td class="header_glay_bg" width="50%">
      <input type="button" value="OK" class="btn_ok1" onClick="buttonPush('ntp093kakunin');">
      <input type="button" class="btn_back_n1" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('ntp093back');"></td>
    ...
    <td valign="middle" align="left" class="td_wt" >
      ...
      <!-- キー1 -->
      <html:select property="ntp093SortKey1">
        <html:optionsCollection name="ntp093Form" property="ntp093SortKeyLabel" value="value" label="label" />
      </html:select>
      <html:radio name="ntp093Form" property="ntp093SortOrder1" styleId="ntp093SortOrder10" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConst.ORDER_KEY_ASC) %>" /><span class="text_base"><label for="ntp093SortOrder10"><gsmsg:write key="cmn.order.asc" /></label></span>&nbsp;
      <html:radio name="ntp093Form" property="ntp093SortOrder1" styleId="ntp093SortOrder11" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConst.ORDER_KEY_DESC) %>" /><span class="text_base"><label for="ntp093SortOrder11"><gsmsg:write key="cmn.order.desc" /></label>&nbsp;</span>
      <br>

      <span class="text_bb1"><gsmsg:write key="cmn.second.key" />：</span>
      <!-- キー2 -->
      <html:select property="ntp093SortKey2">
        <html:optionsCollection name="ntp093Form" property="ntp093SortKeyLabel" value="value" label="label" />
      </html:select>
      <html:radio name="ntp093Form" property="ntp093SortOrder2" styleId="ntp093SortOrder20" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConst.ORDER_KEY_ASC) %>" /><span class="text_base"><label for="ntp093SortOrder20"><gsmsg:write key="cmn.order.asc" /></label></span>&nbsp;
      <html:radio name="ntp093Form" property="ntp093SortOrder2" styleId="ntp093SortOrder21" value="<%= String.valueOf(jp.groupsession.v2.cmn.GSConst.ORDER_KEY_DESC) %>" /><span class="text_base"><label for="ntp093SortOrder21"><gsmsg:write key="cmn.order.desc" /></label>&nbsp;</span>
      <br>

      <span class="text_base">の順に並べて表示します。</span>
    ...
    <td valign="middle" align="left" class="td_wt" >
      <!-- グループ -->
      <html:select name="ntp093Form" property="ntp093DefGroup">

      <logic:notEmpty name="ntp093Form" property="ntp093GroupLabel" scope="request">
      <logic:iterate id="gpBean" name="ntp093Form" property="ntp093GroupLabel" scope="request">
      ...
      <html:option styleClass="select03" value="<%= gpValue %>"><bean:write name="gpBean" property="label" /></html:option>
        ...
        <!--html:optionsCollection name="ntp093Form" property="ntp093GroupLabel" label="value" label="label" /-->
      </html:select>
    </td>
    </tr>
    ...
    <td width="100%" align="right" cellpadding="5" cellspacing="0">
      <input type="button" value="OK" class="btn_ok1" onClick="buttonPush('ntp093kakunin');">
      <input type="button" class="btn_back_n1" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('ntp093back');">
    </td>
    </tr>
    </table>
