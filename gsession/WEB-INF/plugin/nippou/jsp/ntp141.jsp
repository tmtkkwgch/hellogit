...
<td width="100%" align="center">
  ...
  <td align="left">
    ...
    <td width="0%" class="header_white_bg_text" nowrap>[ <gsmsg:write key="ntp.61" /><gsmsg:write key="cmn.entry" /> ]</td>
    ...
    <input type="button" class="btn_back_n1" value="<gsmsg:write key="cmn.back" />" onClick="return buttonPush2('backNtp141');">
  ...
  <td align="left">
    ...
    <tr>
    <td class="table_bg_A5B4E1" width="10%" nowrap><span class="text_bb1"><gsmsg:write key="ntp.123" /></span><span class="text_r2">Å¶</span></td>
    <td align="left" class="td_type20" width="90%">
    <html:text name="ntp141Form" property="ntp141GyomuCode" maxlength="5" style="width:95px;" />
    </td>
    </tr>
    <tr>
    <td class="table_bg_A5B4E1" width="10%" nowrap><span class="text_bb1"><gsmsg:write key="ntp.124" /></span><span class="text_r2">Å¶</span></td>
    <td align="left" class="td_type20" width="90%">
    <html:text name="ntp141Form" property="ntp141GyomuName" maxlength="50" style="width:515px;" />
    </td>
    </tr>
    </table>
  </td>
