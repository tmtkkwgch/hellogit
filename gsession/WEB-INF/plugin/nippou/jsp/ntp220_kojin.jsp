...
<input type="hidden" name="helpPrm" value="kojin">
              ...
              <tr>
                <td valign="top" style="padding-bottom:10px;" width="100%">
                  <table style="padding:0px;margin:0px;">
                    ...
                    <tr>
                      <td valign="middle" colspan="2" style="padding:0px;margin:0px;">
                        <div style="padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px;margin:0px;">
                            <span style="font-size:12px;font-weight:bold;padding-left:12px;" class="text_base"><gsmsg:write key="cmn.group" />:</span>
                            <logic:notEmpty name="ntp220Form" property="ntp220UserLabel" scope="request">
                              <html:select property="ntp220GroupSid" styleClass="select05" onchange="changeShukeiGroupCombo();">
                              ...
                              <span style="font-size:12px;font-weight:bold;padding-left:12px;" class="text_base"><gsmsg:write key="cmn.user" />:</span>
                              <html:select property="ntp220SelectUsrSid"  style="width:100px;" styleClass="select05" onchange="changeUsrCmb();">
                                <html:optionsCollection name="ntp220Form" property="ntp220UserLabel" value="value" label="label" />
                              </html:select>
                            </logic:notEmpty>

                            <logic:empty name="ntp220Form" property="ntp220UserLabel" scope="request">
                              <span style="font-weight:bold;font-size:14px;"><bean:write name="ntp220Form" property="ntp220DspUsrName" /></span>
                              <select name="ntp220GroupSid" class="display_none" style="width:100px;">
                                <option selected value="<bean:write name="ntp220Form" property="ntp220GroupSid" />">
                              </select>
                              <select name="ntp220SelectUsrSid" class="display_none">
                                <option selected value="<bean:write name="ntp220Form" property="ntp220SelectUsrSid" />">
                              </select>
                            </logic:empty>
                        ...
                        <table style="padding:0px;margin:0px;" width="100%">
                          ...
                          <tr>
                                  ...
                                  <td align="right" style="padding-left:5px;width:20%;font-size:10px;color:#333333;padding-right:12px;padding-top:9px;">
                                    ...
                                    <table style="border:1px solid #dddddd;">
                                      <tr>
                                        ...
                                        <td valign="middle" nowrap><span style="font-size:10px;color:#333333;"><gsmsg:write key="ntp.54" /></span></td>
                                        </tr>
                                        <tr>
                                        <td valign="middle">
                                          <div style="background-color:#4bb2c5;width:10px;height:10px;margin:3px;border:1px solid #dddddd;">&nbsp;</div>
                                        </td>
                                        <td valign="middle" nowrap><span style="padding-right:2px;font-size:10px;color:#333333;"><gsmsg:write key="ntp.53" /></span></td>
                                      </tr>
                                    </table>
                            ...
                            <td valign="top" width="50%" class="anything_area display_none">
                              ...
                              <div id="anythingGraph2Area" style="clear:both;">
                                <div id="anythingGraph2" style="height:200px;"></div>
                          ...
                          <tr>
                            <td class="anything_child_area display_none" valign="top" width="50%" style="border:1px solid #939393;">
                              ...
                              <table width="100%">
                                <tr>
                                  <td style="width:80%;font-size:10px;color:#333333;padding-left:10px;padding-top:9px;"><div class="shoudan_rsult_text"><span style="font-size:12px;font-weight:bold;"><span class="child_sel_content_title"><gsmsg:write key="ntp.64" /></span></span>&nbsp;&nbsp;</div></td>
                              ...
                              <div id="anythingChild1GraphArea" style="text-valign:top;clear:both;">
                                <div id="anythingChild1Graph" style="height:200px;"></div>
                          ...
                          <tr>
                            ...
                            <td class="def_graph" height="200px" valign="top" style="border:1px solid #939393;">
                              ...
                              <div id="shohinGraphArea" style="clear:both;">
                                <div id="shohinGraph" style="height:200px;"></div>
