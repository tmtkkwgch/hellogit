...
<td width="100%" align="center">
  ...
  <td align="left">
    ...
    <td width="100%" class="header_ktool_bg_text">[ <gsmsg:write key="ntp.1" /> <gsmsg:write key="cmn.manual.delete" /><gsmsg:write key="cmn.setting" /> ]</td>
    ...
    <td class="header_glay_bg" width="50%">
      <input type="button" value="<gsmsg:write key="cmn.delete" />" class="btn_dell_n1" onClick="buttonPush('ntp083kakunin');">
      <input type="button" class="btn_back_n3" value="<gsmsg:write key="cmn.back.admin.setting" />" onClick="buttonPush('ntp083back');"></td>
    ...
    <tr>
    <td class="table_bg_A5B4E1" width="15%"><span class="text_bb1"><gsmsg:write key="cmn.manual.delete" /></span><span class="text_r2">※</span></td>
    <td class="td_type1">
      <span class="text_base"><gsmsg:write key="ntp.87" /></span><br><br>

      <!-- 年 -->
      <html:select property="ntp083DelYear">
        <html:optionsCollection name="ntp083Form" property="ntp083DelYearLabel" value="value" label="label" />
      </html:select>

      <!-- 月 -->
      <html:select property="ntp083DelMonth">
