...
<td width="100%" align="center">
  ...
  <td align="left">
    ...
    <tr>
    <td class="table_bg_A5B4E1" width="10%" nowrap><span class="text_bb1"><gsmsg:write key="ntp.126" /></span><span class="text_r2">Å¶</span></td>
    <td align="left" class="td_type20" width="90%">
    <html:text name="ntp151Form" property="ntp151ProcessCode" maxlength="5" style="width:95px;" />
    </td>
    </tr>
    <tr>
    <td class="table_bg_A5B4E1" width="10%" nowrap><span class="text_bb1"><gsmsg:write key="ntp.127" /></span><span class="text_r2">Å¶</span></td>
    <td align="left" class="td_type20" width="90%">
