...
<body class="body_03">
<html:form action="/nippou/ntp096">

<input type="hidden" name="CMD" value="">
<html:hidden property="dspMod" />
<html:hidden property="listMod" />
<html:hidden property="backScreen" />
<html:hidden property="ntp096InitFlg" />
...
<td width="100%" align="center">
  ...
  <td align="left">
    ...
    <td width="100%" class="header_ktool_bg_text">[ <gsmsg:write key="ntp.108" /> ]</td>
    ...
    <td class="header_glay_bg" width="50%">
      <input type="button" value="OK" class="btn_ok1" onClick="buttonPush('ntp096kakunin');">
      <input type="button" class="btn_back_n1" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('ntp096back');"></td>
    ...
    <td width="0%" valign="middle" align="left" class="table_bg_A5B4E1" nowrap>
      <span class="text_bb1"><gsmsg:write key="ntp.115" /></span><span class="text_r2">※</span>
    </td>
    <td width="100%" valign="middle" align="left" class="td_wt" >
      <div class="text_r1">※<gsmsg:write key="ntp.116" /></div>
      <html:radio name="ntp096Form" styleId="ntp096SchKbn_01" property="ntp096SchKbn" value="<%= String.valueOf(jp.groupsession.v2.ntp.GSConstNippou.SCH_DSP_YES) %>" /><label for="ntp096SchKbn_01"><span class="text_base"><gsmsg:write key="reserve.show.ok" /></span></label>&nbsp;
      <html:radio name="ntp096Form" styleId="ntp096SchKbn_02" property="ntp096SchKbn" value="<%= String.valueOf(jp.groupsession.v2.ntp.GSConstNippou.SCH_DSP_NO) %>" /><label for="ntp096SchKbn_02"><span class="text_base"><gsmsg:write key="fil.65" /></span></label>
    </td>
    </tr>
    ...
    <td width="100%" align="right" cellpadding="5" cellspacing="0">
      <input type="button" value="OK" class="btn_ok1" onClick="buttonPush('ntp096kakunin');">
      <input type="button" class="btn_back_n1" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('ntp096back');">
    </td>
    </tr>
    </table>
