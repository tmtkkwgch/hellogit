...
/**
 * <br>[機  能] 日報 管理者設定 インポート確認画面のビジネスロジッククラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Ntp084knBiz {

    /** Logging インスタンス */
    private static Log log__ = LogFactory.getLog(Ntp084knBiz.class);
    /** リクエスモデル */
     ...
     * @param con コネクション
     */
    public Ntp084knBiz(RequestModel reqMdl, Connection con) {
        reqMdl_ = reqMdl;
        con_ = con;
    }
     ...
     * <br>[備  考]
     *
     * @param paramMdl Ntp084knParamModel
     * @param tempDir テンポラリファイルパス
     * @throws SQLException SQL実行例外
     * @throws IOToolsException CSVファイル取扱い時例外
     */
    public void setImportFileName(Ntp084knParamModel paramMdl, String tempDir)
        throws SQLException, IOToolsException {

        //取込みCSVファイル名称セット
        String fileName = __getFileName(tempDir);
        paramMdl.setNtp084knFileName(fileName);
    }
    /**
     * <br>[機  能] 取込みファイル名称を画面にセットする
     * <br>[解  説]
