...
import jp.groupsession.v2.ntp.ntp020.Ntp020ParamModel;
 ...
 * @author JTS
 */
public class Ntp030ParamModel extends Ntp020ParamModel {

    /** Logging インスタンス */
    private static Log log__ = LogFactory.getLog(Ntp030ParamModel.class);
