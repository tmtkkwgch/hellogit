...
/**
 * <br>[機  能] 日報 活動分類一覧画面のアクションクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Ntp170Action extends AbstractNippouAdminAction {

    /** Logging インスタンス */
    private static Log log__ = LogFactory.getLog(Ntp170Action.class);
    ...
    public ActionForward executeAction(ActionMapping map,
        ...
        Ntp170Form thisForm = (Ntp170Form) form;

        if (cmd.equals("backNtp170")) {
            forward = map.findForward("ntp120");
        } else if (cmd.equals("add") || cmd.equals("edit")) {
            forward = map.findForward("ntp171");
        } else if (cmd.equals("upBunruiData")) {
            //上へボタンクリック
            forward = __doSortChange(map, thisForm, req, res, con, GSConstNippou.SORT_UP);
        } else if (cmd.equals("downBunruiData")) {
            //下へボタンクリック
    ...
    private ActionForward __doInit(ActionMapping map,
        ...
        Ntp170Biz biz = new Ntp170Biz(getRequestModel(req));

        Ntp170ParamModel paramMdl = new Ntp170ParamModel();
