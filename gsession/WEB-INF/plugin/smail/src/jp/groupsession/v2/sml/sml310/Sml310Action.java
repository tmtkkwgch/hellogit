...
/**
 * <br>[機  能] ショートメール ラベルの管理画面のアクションクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Sml310Action extends AbstractSmlAction {

    /** Logging インスタンス */
    private static Log log__ = LogFactory.getLog(Sml310Action.class);
    ...
    public ActionForward executeSmail(ActionMapping map, ActionForm form,
        ...
        Sml310Form thisForm = (Sml310Form) form;
        ...
        } else if (cmd.equals("smlUserAccountList")) {
            //戻るボタンクリック
     ...
     */
    private ActionForward __doInit(ActionMapping map, Sml310Form form,
            HttpServletRequest req, HttpServletResponse res, Connection con)
            throws Exception {
     ...
     * @throws Exception 実行時例外
     */
    public ActionForward __doConfig(ActionMapping map, Sml310Form form,
            HttpServletRequest req, HttpServletResponse res, Connection con)
            throws Exception {
