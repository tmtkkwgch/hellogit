...
import jp.groupsession.v2.sml.sml350.Sml350ParamModel;


import org.apache.struts.util.LabelValueBean;

/**
 * <br>[機  能] ショートメール 個人設定 フィルタ登録画面のパラメータ情報を保持するModelクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Sml360ParamModel extends Sml350ParamModel {
    /** フィルター区分 全ての条件に一致 */
