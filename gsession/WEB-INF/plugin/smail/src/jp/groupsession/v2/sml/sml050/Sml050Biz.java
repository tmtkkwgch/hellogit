 ...
 * @author JTS
 */
public class Sml050Biz {

    /** Logging インスタンス */
    private static Log log__ = LogFactory.getLog(Sml050Biz.class);
     ...
     */
    public void setInitData(Sml050ParamModel paramMdl,
                            RequestModel reqMdl,
                            Connection con)
        throws SQLException {
        ...
        if (paramMdl.getSmlAccountSid() <= 0
                || paramMdl.getSml050InitFlg() == GSConstSmail.DSP_FIRST) {
        ...
        if (sacMdl != null) {
            ...
            paramMdl.setSml050AccountName(sacMdl.getSacName());
        }
        ...
        paramMdl.setSml050InitFlg(GSConstSmail.DSP_ALREADY);
    }
}