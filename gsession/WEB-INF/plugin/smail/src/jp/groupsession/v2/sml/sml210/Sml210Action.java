 ...
 * @author JTS
 */
public class Sml210Action extends AbstractSmlAction {

    /** Logging インスタンス */
    private static Log log__ = LogFactory.getLog(Sml210Action.class);
    ...
    public boolean canNotAdminAccess(HttpServletRequest req, ActionForm form) {
        return (form != null
                && ((Sml210Form) form).getSml050HinaKbn() == GSConstSmail.HINA_KBN_PRI);
    }
    ...
    public ActionForward executeSmail(ActionMapping map,
        ...
        Sml210Form smlform = (Sml210Form) form;
...
//            forward = map.findForward("hinaInput");
    ...
    private ActionForward __doInit(ActionMapping map,
        ...
        Sml210ParamModel paramMdl = new Sml210ParamModel();
        paramMdl.setParam(form);
        //ひな形一覧を取得する
        Sml210Biz biz = new Sml210Biz();
