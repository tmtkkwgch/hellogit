...
/**
 * <br>[機  能] ショートメール 管理者設定 統計情報画面アクションクラス
 * <br>[解  説]
 * <br>[備  考]
 */
public class Sml370Action extends AbstractSmailAdminAction {

    /** Logging インスタンス */
    private static Log log__ = LogFactory.getLog(Sml370Action.class);
     ...
     */
     public ActionForward executeAction(ActionMapping map,
         ...
         Sml370Form thisForm = (Sml370Form) form;
         ...
         } else if (cmd.equals("sysMailChange")) {
     ...
     * @throws SQLException SQL実行時例外
      * @return アクションフォーム
      */
     private ActionForward __movePage(ActionMapping map, Sml370Form form,
                     HttpServletRequest req, HttpServletResponse res, Connection con, int pageNo)
             throws SQLException {

         //ページ数調整
         int page = form.getSml370NowPage();
         page += pageNo;
         if (page < 1) {
             page = 1;
         }
         form.setSml370NowPage(page);
     ...
     * @throws SQLException SQL実行時例外
     ...
     private ActionForward __doInit(ActionMapping map,
         ...
         Sml370Biz biz = new Sml370Biz(con, getRequestModel(req));

         Sml370ParamModel paramMdl = new Sml370ParamModel();
     ...
     * @return ActionForward
     */
    private ActionForward __backToMenu(ActionMapping map, Sml370Form form) {
        ActionForward forward = null;
