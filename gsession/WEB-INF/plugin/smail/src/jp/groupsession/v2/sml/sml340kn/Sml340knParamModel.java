...
import jp.groupsession.v2.sml.sml340.Sml340ParamModel;


/**
 * <br>[機  能] ショートメール 管理者設定 フィルタ登録確認画面のパラメータ情報を保持するModelクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Sml340knParamModel extends Sml340ParamModel {
    /** 条件１ 条件 */
