...
import jp.groupsession.v2.sml.sml330.Sml330ParamModel;


import org.apache.struts.util.LabelValueBean;

/**
 * <br>[機  能] ショートメール 管理者設定 フィルタ登録画面のパラメータ情報を保持するModelクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Sml340ParamModel extends Sml330ParamModel {
    /** フィルター区分 全ての条件に一致 */
