...
/**
 * <br>[機  能] ショートメール ラベルの管理画面で使用するDAOクラス
 * <br>[解  説]
 * <br>[備  考]
 *
 * @author JTS
 */
public class Sml310Dao extends AbstractDao {

    /** Logging インスタンス */
    private static Log log__ = LogFactory.getLog(Sml310Dao.class);
     ...
     * @param con コネクション
     */
    public Sml310Dao(Connection con) {
        super(con);
    }
     ...
     * <br>[解  説]
     * <br>[備  考]
     * @param sml310account アカウントSID
     * @return アカウントリスト
     * @throws SQLException SQL実行時例外
     */
    public List<LabelDataModel> getLabelList(int sml310account)
    throws SQLException {
