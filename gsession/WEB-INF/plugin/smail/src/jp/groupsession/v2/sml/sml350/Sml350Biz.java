...
public class Sml350Biz {
     ...
     * @throws SQLException SQL実行時例外
     */
    public void updateSort(Connection con, Sml350ParamModel paramMdl, int changeKbn)
        throws SQLException {
        ...
        //ラジオ選択値取得
        String selectedKey = paramMdl.getSml350SortRadio();
        ...
        //新しいキーを設定
        paramMdl.setSml350SortRadio(__getRadioValueStr(motoSid, sakiSort, target));
    }
