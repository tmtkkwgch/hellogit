package jp.groupsession.v2.sml.sml220;
 ...
 * @author JTS
 */
public class Sml220Action extends AbstractSmlAction {

    /** Logging インスタンス */
    private static Log log__ = LogFactory.getLog(Sml220Action.class);
    ...
    public boolean canNotAdminAccess(HttpServletRequest req, ActionForm form) {
        return (form != null
                && ((Sml220Form) form).getSml050HinaKbn() == GSConstSmail.HINA_KBN_PRI);
    }
    ...
    public ActionForward executeSmail(ActionMapping map,
        ...
        Sml220Form smlform = (Sml220Form) form;
        ...
        //追加ボタン押下
        if (cmd.equals("filterAdd")) {
            log__.debug("追加ボタン押下");
            forward = map.findForward("filterEdit");
        //戻るボタン押下
        } else if (cmd.equals("backFromfilter")) {
            log__.debug("戻るボタン押下");
    ...
    private ActionForward __doInit(ActionMapping map,
        ...
        Sml220ParamModel paramMdl = new Sml220ParamModel();
        paramMdl.setParam(form);
        //ひな形一覧を取得する
        Sml220Biz biz = new Sml220Biz();
