...
<title>[Group Session] <gsmsg:write key="wml.86" /></title>
  ...
  <script language="JavaScript" src="../smail/js/sml330.js?<%= GSConst.VERSION_PARAM %>"></script>
</head>
...
<td width="100%" align="center">
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
      <tr>
        ...
        <td class="header_glay_bg" width="50%">
          ...
          <input type="button" name="btn_facilities_mnt" class="btn_back_n1" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('sml330Back');">
        </td>
  ...
  <tr><td>
    ...
    <td align="left" class="smail_td1" width="100%"><bean:write name="sml330Form" property="sml330accountName" /></td>
    </tr>
    </table>
    ...
    <logic:iterate id="filData" name="sml330Form" property="filList" indexId="idx">
      ...
      <tr>
      <td align="center" class="smail_td1" nowrap><html:radio property="sml330SortRadio" value="<%= String.valueOf(filValue) %>" styleId="<%= filterCheckId %>" /></td>
      <td align="left" class="smail_td1" onClick="sml330CheckFilter('<%= filterCheckId %>');">
