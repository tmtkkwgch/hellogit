...
<title>[Group Session] <gsmsg:write key="wml.wml110.01" /></title>
  ...
  <script language="JavaScript" src="../smail/js/sml290.js?<%= GSConst.VERSION_PARAM %>"></script>
</head>
...
<td width="100%" align="center">
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
      <tr>
        ...
        <td class="header_glay_bg" width="50%">
          ...
          <input type="button" name="btn_facilities_mnt" class="btn_back_n1" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('sml240Back');">
        </td>
  ...
  <tr><td>
    ...
    <logic:iterate id="lbnData" name="sml290Form" property="lbnList" indexId="idx">
      ...
      <tr>
      <td align="center" class="smail_td1" nowrap><html:radio property="sml290SortRadio" value="<%= String.valueOf(lbValue) %>" styleId="<%= labelCheckId %>" /></td>
      <td align="left" class="smail_td1" onClick="sml110CheckLabel('<%= labelCheckId %>');">
