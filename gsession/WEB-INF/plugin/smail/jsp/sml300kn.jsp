...
<html:form action="/smail/sml300kn">
...
<html:hidden property="sml300LabelName" />
...
<td width="100%" align="center">
  ...
  <td>
    ...
    <td align="left" class="td_wt" width="70%">
      <bean:write name="sml300knForm" property="sml290accountName" />
    </td>
    </tr>
    <tr>
    <td class="table_bg_A5B4E1" width="30%" nowrap><span class="text_bb1"><gsmsg:write key="wml.74" /></span></td>
    <td align="left" class="td_wt" width="70%"><bean:write name="sml300knForm" property="sml300LabelName" /></td>
    </tr>
    </table>
