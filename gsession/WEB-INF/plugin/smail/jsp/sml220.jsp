...
<script language="JavaScript" src="../smail/js/sml220.js?<%= GSConst.VERSION_PARAM %>"></script>
...
<title>[GroupSession]
<logic:equal name="sml220Form" property="sml050HinaKbn" value="<%= String.valueOf(jp.groupsession.v2.sml.GSConstSmail.HINA_KBN_CMN) %>"><gsmsg:write key="sml.sml050.01" /></logic:equal>
<logic:equal name="sml220Form" property="sml050HinaKbn" value="<%= String.valueOf(jp.groupsession.v2.sml.GSConstSmail.HINA_KBN_PRI) %>"><gsmsg:write key="sml.sml050.02" /></logic:equal>
</title>
</head>

<body class="body_03">
<html:form action="/smail/sml220">
...
<logic:notEmpty name="sml220Form" property="sml010DelSid" scope="request">
  <logic:iterate id="del" name="sml220Form" property="sml010DelSid" scope="request">
  ...
  <td>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
      <tr>
        ...
        <td width="100%" class="header_ktool_bg_text2">[ フィルタ設定 ]</td>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
      <tr>
        ...
        <td class="header_glay_bg" width="50%">
          <input type="button" name="btn_add" class="btn_add_n1" value="追加"  onClick="buttonPush('filterAdd');">
          <input type="button" name="btn_facilities_mnt" class="btn_back_n1" value="戻る" onClick="buttonPush('backFromfilter');">
        </td>
  ...
  <tr><td>
    ...
    <tr>
      <td style="white-space:nowrap;">
        <input type="button" class="btn_base0" value="上へ" name="btn_upper" onClick="buttonPush('upFilterData');">
        <input type="button" class="btn_base0" value="下へ" name="btn_downer" onClick="buttonPush('downFilterData');">
      </td>
      <td align="left" width="100%"><span class="text_base3">フィルタは上から順に評価されます</span></td>
    </tr>
    </table>
    ...
    <th align="center" class="table_bg_7D91BD" width="100%"><span class="text_tlw">フィルター名</span></th>
    ...
    <th align="center" class="table_bg_7D91BD" width="0%"><span class="text_tlw">削除</span></th>
      ...
      <tr>
      <td align="center" class="smail_td1" nowrap><input type="radio" name="wml130SortRadio" value="1:1:0" checked="checked" id="chkFilter0"></td>
      <td align="left" class="smail_td1" onClick="wml130CheckFilter('chkFilter0');">
        フィルタの1
      </td>
      <td align="left" class="smail_td1"><input type="button" class="btn_edit_n3" value="修正" name="btn_change"  onClick="buttonPush('filterAdd');"></td>
      <td align="left" class="smail_td1"><input type="button" class="btn_dell_n3" value="削除" name="btn_delete" onClick="deleteFilter('1');"></td>
      </tr>
