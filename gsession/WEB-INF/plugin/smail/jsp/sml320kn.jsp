...
<html:form action="/smail/sml320kn">
...
<html:hidden property="sml320LabelName" />
...
<td width="100%" align="center">
  ...
  <td>
    ...
    <td align="left" class="td_wt" width="70%">
      <bean:write name="sml320knForm" property="sml310account" />
    </td>
    </tr>
    <tr>
    <td class="table_bg_A5B4E1" width="30%" nowrap><span class="text_bb1"><gsmsg:write key="wml.74" /></span></td>
    <td align="left" class="td_wt" width="70%"><bean:write name="sml320Form" property="sml320LabelName" /></td>
    </tr>
    </table>
