...
<td width="100%" align="center">
  ...
  <td>
    ...
    <td class="td_type1">
      <html:radio name="sml280Form" property="sml280acntMakeKbn" value="<%= String.valueOf(GSConstSmail.KANRI_USER_ONLY) %>" styleId="acntMake2" /><label for="acntMake2"><gsmsg:write key="wml.70" /></label>
    ...
    <td class="td_type1">
      <html:radio name="sml280Form" property="sml280autoDelKbn" value="<%= String.valueOf(GSConstSmail.AUTO_DEL_ADM) %>" styleId="autoDel1" /><label for="autoDel1"><gsmsg:write key="cmn.set.the.admin" /></label>
      &nbsp;<html:radio name="sml280Form" property="sml280autoDelKbn" value="<%= String.valueOf(GSConstSmail.AUTO_DEL_ACCOUNT) %>" styleId="autoDel2" /><label for="autoDel2"><gsmsg:write key="cmn.set.eachaccount" /></label>
    </td>
    </tr>
    <tr>
    ...
    <td class="td_type1">
      <html:radio name="sml280Form" property="sml280acntUser" value="<%= String.valueOf(GSConstSmail.KANRI_ACCOUNT_USER_ONLY) %>" styleId="acntUser1" /><label for="acntUser1"><gsmsg:write key="cmn.only.admin.setting" /></label>
